...
HX_DEFINE_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_1369_new,"OffsetMenu","new",0x7b26d4e4,"OffsetMenu.new","Options.hx",1369,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_1375_press,"OffsetMenu","press",0xe1888107,"OffsetMenu.press","Options.hx",1375,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_14eb50a9d1a4948f_1390_updateDisplay,"OffsetMenu","updateDisplay",0xd3a7e0bd,"OffsetMenu.updateDisplay","Options.hx",1390,0x9d9a0240)

void OffsetMenu_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_1369_new)
...
bool OffsetMenu_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_1375_press)
HXLINE(1376)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),1376,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
HXLINE(1378)		::PlayState_obj::SONG = ::Song_obj::loadFromJson(HX_("tutorial",9e,8f,b5,82),HX_("",00,00,00,00));
HXLINE(1379)		::PlayState_obj::isStoryMode = false;
HXLINE(1380)		::PlayState_obj::storyDifficulty = 0;
HXLINE(1381)		::PlayState_obj::storyWeek = 0;
HXLINE(1382)		::PlayState_obj::offsetTesting = true;
HXLINE(1383)		::haxe::Log_obj::trace((HX_("CUR WEEK",b4,9a,a0,36) + ::PlayState_obj::storyWeek),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),1383,HX_("OffsetMenu",f2,d2,21,3b),HX_("press",83,53,88,c8)));
HXLINE(1384)		{
HXLINE(1384)			 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
HXDLIN(1384)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(1384)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
HXLINE(1385)		return false;
            	}


::String OffsetMenu_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_14eb50a9d1a4948f_1390_updateDisplay)
HXDLIN(1390)		return HX_("Time your offset",ed,a5,d2,d4);
            	}
