...
HX_DEFINE_STACK_FRAME(_hx_pos_9bd24c9adde08dff_35_new,"Conductor","new",0xc2a20839,"Conductor.new","Conductor.hx",35,0xeb0fa157)
...
HX_LOCAL_STACK_FRAME(_hx_pos_9bd24c9adde08dff_74_recalculateTimingStruct,"Conductor","recalculateTimingStruct",0xaba6fecb,"Conductor.recalculateTimingStruct","Conductor.hx",74,0xeb0fa157)
...
void Conductor_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_35_new)
            	}
...
HXDLIN(  69)		::String _hx_tmp1 = (HX_("new BPM map BUDDY ",ff,cc,e3,2e) + ::Std_obj::string(::Conductor_obj::bpmChangeMap));
HXDLIN(  69)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/Conductor.hx",4b,4e,2d,f0),69,HX_("Conductor",c7,77,a1,7b),HX_("mapBPMChanges",a0,c9,ba,4a)));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(Conductor_obj,mapBPMChanges,(void))

void Conductor_obj::recalculateTimingStruct( ::Dynamic SONG){
            	HX_STACKFRAME(&_hx_pos_9bd24c9adde08dff_74_recalculateTimingStruct)
HXDLIN(  74)		int _g = 0;
HXDLIN(  74)		::Array< ::Dynamic> _g1 = ( (::Array< ::Dynamic>)(SONG->__Field(HX_("eventObjects",da,5f,a4,12),::hx::paccDynamic)) );
HXDLIN(  74)		while((_g < _g1->length)){
HXDLIN(  74)			 ::Event i = _g1->__get(_g).StaticCast<  ::Event >();
HXDLIN(  74)			_g = (_g + 1);
            		}
            	}
