...
HX_DEFINE_STACK_FRAME(_hx_pos_04fa384cfca16a40_578_new,"polymod.backends._LimeBackend.IdAndLibrary","new",0x62fe42a8,"polymod.backends._LimeBackend.IdAndLibrary.new","polymod/backends/LimeBackend.hx",578,0xcff7dfd6)
namespace polymod{
namespace backends{
...
void IdAndLibrary_obj::__construct(::String id, ::haxe::ds::StringMap libs, ::polymod::backends::LimeModLibrary l){
            	HX_STACKFRAME(&_hx_pos_04fa384cfca16a40_578_new)
HXLINE( 579)		this->fallbackId = id;
HXLINE( 580)		int colonIndex = id.indexOf(HX_(":",3a,00,00,00),null());
HXLINE( 581)		this->lib = id.substring(0,colonIndex);
HXLINE( 582)		this->nakedId = id.substring((colonIndex + 1),null());
HXLINE( 583)		if (::hx::IsNotNull( l )) {
HXLINE( 585)			this->library = l;
            		}
            		else {
HXLINE( 587)			if (::hx::IsNotNull( libs )) {
HXLINE( 589)				bool _hx_tmp;
HXDLIN( 589)				if ((this->lib != HX_("",00,00,00,00))) {
HXLINE( 589)					_hx_tmp = ::hx::IsNull( this->lib );
            				}
            				else {
HXLINE( 589)					_hx_tmp = true;
            				}
HXDLIN( 589)				if (_hx_tmp) {
HXLINE( 591)					this->lib = HX_("default",c1,d8,c3,9b);
            				}
HXLINE( 593)				this->library = ( ( ::polymod::backends::LimeModLibrary)(libs->get(this->lib)) );
            			}
            		}
HXLINE( 595)		bool _hx_tmp;
HXDLIN( 595)		bool _hx_tmp1;
HXDLIN( 595)		if (::hx::IsNotNull( this->library )) {
HXLINE( 595)			_hx_tmp1 = ::hx::IsNotNull( this->library->pathPrefix );
            		}
            		else {
HXLINE( 595)			_hx_tmp1 = false;
            		}
HXDLIN( 595)		if (_hx_tmp1) {
HXLINE( 595)			_hx_tmp = (this->library->pathPrefix != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 595)			_hx_tmp = false;
            		}
HXDLIN( 595)		if (_hx_tmp) {
HXLINE( 597)			this->modId = ((this->library->pathPrefix + HX_("/",2f,00,00,00)) + this->nakedId);
            		}
HXLINE( 599)		this->modId = this->nakedId;
            	}
