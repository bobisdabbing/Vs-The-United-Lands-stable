...
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_151_getBytes,"polymod.backends.PolymodAssets","getBytes",0xe73dfe41,"polymod.backends.PolymodAssets.getBytes","polymod/backends/PolymodAssets.hx",151,0xd8b6783c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_161_getPath,"polymod.backends.PolymodAssets","getPath",0xf8fffc8f,"polymod.backends.PolymodAssets.getPath","polymod/backends/PolymodAssets.hx",161,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_5b88a33584460d08_166_list,"polymod.backends.PolymodAssets","list",0x3565ecaa,"polymod.backends.PolymodAssets.list","polymod/backends/PolymodAssets.hx",166,0xd8b6783c)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(PolymodAssets_obj,exists,return )
 ...
 ::haxe::io::Bytes PolymodAssets_obj::getBytes(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_151_getBytes)
HXDLIN( 151)		return ::polymod::backends::PolymodAssets_obj::library->getBytes(id);
            	}
...
::String PolymodAssets_obj::getPath(::String id){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_161_getPath)
HXDLIN( 161)		return ::polymod::backends::PolymodAssets_obj::library->getPath(id);
            	}
...
::Array< ::String > PolymodAssets_obj::list(::String type){
            	HX_STACKFRAME(&_hx_pos_5b88a33584460d08_166_list)
HXDLIN( 166)		return ::polymod::backends::PolymodAssets_obj::library->list(type);
            	}
