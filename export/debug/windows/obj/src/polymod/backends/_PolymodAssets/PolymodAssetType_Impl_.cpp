...
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_208_fromString,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","fromString",0xa9047b18,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.fromString","polymod/backends/PolymodAssets.hx",208,0xd8b6783c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_202_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",202,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_203_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",203,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_204_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",204,0xd8b6783c)
HX_LOCAL_STACK_FRAME(_hx_pos_f18b9fd15d26d526_205_boot,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_","boot",0x35ee15af,"polymod.backends._PolymodAssets.PolymodAssetType_Impl_.boot","polymod/backends/PolymodAssets.hx",205,0xd8b6783c)
namespace polymod{
namespace backends{
...
::String PolymodAssetType_Impl__obj::fromString(::String str){
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_208_fromString)
HXLINE( 209)		str = str.toUpperCase();
HXLINE( 210)		::String _hx_switch_0 = str;
...
HXLINE( 213)			return str;
HXDLIN( 213)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE( 215)			return HX_("UNKNOWN",6a,f7,4e,61);
            		}
            		_hx_goto_0:;
...
HXDLIN( 195)		BYTES = HX_("BYTES",4b,40,86,3b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_196_boot)
HXDLIN( 196)		TEXT = HX_("TEXT",ad,94,ba,37);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_197_boot)
HXDLIN( 197)		IMAGE = HX_("IMAGE",3b,57,57,3b);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_198_boot)
HXDLIN( 198)		VIDEO = HX_("VIDEO",5b,4c,ea,b4);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_199_boot)
HXDLIN( 199)		FONT = HX_("FONT",cf,25,81,2e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_200_boot)
HXDLIN( 200)		AUDIO_GENERIC = HX_("AUDIO_GENERIC",2e,f6,26,23);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_201_boot)
HXDLIN( 201)		AUDIO_MUSIC = HX_("AUDIO_MUSIC",fc,6c,05,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_202_boot)
HXDLIN( 202)		AUDIO_SOUND = HX_("AUDIO_SOUND",26,29,77,b8);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_203_boot)
HXDLIN( 203)		MANIFEST = HX_("MANIFEST",af,8b,af,29);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_204_boot)
HXDLIN( 204)		TEMPLATE = HX_("TEMPLATE",3a,78,cd,05);
            	}
{
            	HX_STACKFRAME(&_hx_pos_f18b9fd15d26d526_205_boot)
HXDLIN( 205)		UNKNOWN = HX_("UNKNOWN",6a,f7,4e,61);
            	}
}
