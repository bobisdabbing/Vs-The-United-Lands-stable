...
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_23_get_debug,"polymod.PolymodConfig","get_debug",0x074ffd7c,"polymod.PolymodConfig.get_debug","polymod/PolymodConfig.hx",23,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_41_get_rootPath,"polymod.PolymodConfig","get_rootPath",0x11eead5e,"polymod.PolymodConfig.get_rootPath","polymod/PolymodConfig.hx",41,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_61_get_useNamespaceInPaths,"polymod.PolymodConfig","get_useNamespaceInPaths",0xef313efe,"polymod.PolymodConfig.get_useNamespaceInPaths","polymod/PolymodConfig.hx",61,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_79_get_scriptExt,"polymod.PolymodConfig","get_scriptExt",0x538e82ff,"polymod.PolymodConfig.get_scriptExt","polymod/PolymodConfig.hx",79,0x8e4837ff)
HX_LOCAL_STACK_FRAME(_hx_pos_cae42745e4bfdcf9_98_get_scriptLibrary,"polymod.PolymodConfig","get_scriptLibrary",0x2f4f2459,"polymod.PolymodConfig.get_scriptLibrary","polymod/PolymodConfig.hx",98,0x8e4837ff)
...
static const ::String _hx_array_data_a82454c0_11[] = {
...
bool PolymodConfig_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic PolymodConfig_obj::get_debug(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_23_get_debug)
HXLINE(  25)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::debug )) {
HXLINE(  26)			::polymod::PolymodConfig_obj::debug = false;
            		}
HXLINE(  27)		return ::polymod::PolymodConfig_obj::debug;
            	}
...
::String PolymodConfig_obj::get_rootPath(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_41_get_rootPath)
HXLINE(  43)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::rootPath )) {
HXLINE(  44)			::polymod::PolymodConfig_obj::rootPath = HX_("data/",c5,0e,88,d4);
            		}
HXLINE(  45)		return ::polymod::PolymodConfig_obj::rootPath;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(PolymodConfig_obj,get_rootPath,return )
 ...
 ::Dynamic PolymodConfig_obj::get_useNamespaceInPaths(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_61_get_useNamespaceInPaths)
HXLINE(  63)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::useNamespaceInPaths )) {
HXLINE(  64)			::polymod::PolymodConfig_obj::useNamespaceInPaths = false;
            		}
HXLINE(  65)		return ::polymod::PolymodConfig_obj::useNamespaceInPaths;
            	}
...
::String PolymodConfig_obj::get_scriptExt(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_79_get_scriptExt)
HXLINE(  81)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::scriptExt )) {
HXLINE(  82)			::polymod::PolymodConfig_obj::scriptExt = HX_(".txt",02,3f,c0,1e);
            		}
HXLINE(  83)		return ::polymod::PolymodConfig_obj::scriptExt;
            	}
...
::String PolymodConfig_obj::get_scriptLibrary(){
            	HX_STACKFRAME(&_hx_pos_cae42745e4bfdcf9_98_get_scriptLibrary)
HXLINE( 100)		if (::hx::IsNull( ::polymod::PolymodConfig_obj::scriptLibrary )) {
HXLINE( 101)			::polymod::PolymodConfig_obj::scriptLibrary = HX_("default",c1,d8,c3,9b);
            		}
HXLINE( 102)		return ::polymod::PolymodConfig_obj::scriptLibrary;
            	}
...
HXLINE( 210)			::polymod::PolymodConfig_obj::modIgnoreFiles = ::Array_obj< ::String >::fromData( _hx_array_data_a82454c0_11,3);
            		}
