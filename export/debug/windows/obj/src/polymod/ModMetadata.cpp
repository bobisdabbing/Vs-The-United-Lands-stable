...
HX_LOCAL_STACK_FRAME(_hx_pos_bf85bbb123aa7472_499_toJsonStr,"polymod.ModMetadata","toJsonStr",0xb10a2a39,"polymod.ModMetadata.toJsonStr","polymod/Polymod.hx",499,0xd80c6d61)
...
::String ModMetadata_obj::toJsonStr(){
            	HX_STACKFRAME(&_hx_pos_bf85bbb123aa7472_499_toJsonStr)
HXLINE( 500)		 ::Dynamic json =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 501)		::Reflect_obj::setField(json,HX_("title",98,15,3b,10),this->title);
HXLINE( 502)		::Reflect_obj::setField(json,HX_("description",fc,08,1d,5f),this->description);
HXLINE( 503)		::Reflect_obj::setField(json,HX_("author",8b,ea,7b,73),this->author);
HXLINE( 504)		::Reflect_obj::setField(json,HX_("api_version",33,67,89,30),this->apiVersion->toString());
HXLINE( 505)		::Reflect_obj::setField(json,HX_("mod_version",5b,e9,f4,5b),this->modVersion->toString());
HXLINE( 506)		::Reflect_obj::setField(json,HX_("license",81,d3,48,ca),this->license);
HXLINE( 507)		::Reflect_obj::setField(json,HX_("license_ref",55,46,81,a0),this->licenseRef);
HXLINE( 508)		 ::Dynamic meta =  ::Dynamic(::hx::Anon_obj::Create(0));
HXLINE( 509)		{
HXLINE( 509)			 ::Dynamic key = this->metaData->keys();
HXDLIN( 509)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 509)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 511)				::Reflect_obj::setField(meta,key1,this->metaData->get(key1));
            			}
            		}
HXLINE( 513)		::Reflect_obj::setField(json,HX_("metadata",6f,e7,19,40),meta);
HXLINE( 514)		 ::Dynamic replacer = null();
HXDLIN( 514)		return ::haxe::format::JsonPrinter_obj::print(json,replacer,HX_("    ",00,38,3f,15));
            	}
