...
HX_DEFINE_STACK_FRAME(_hx_pos_0223c7916a99f2e4_1527_new,"MiddleScrollOption","new",0xfbf83ee9,"MiddleScrollOption.new","Options.hx",1527,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0223c7916a99f2e4_1536_left,"MiddleScrollOption","left",0x7bec515e,"MiddleScrollOption.left","Options.hx",1536,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0223c7916a99f2e4_1545_right,"MiddleScrollOption","right",0x69e7eea5,"MiddleScrollOption.right","Options.hx",1545,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0223c7916a99f2e4_1552_updateDisplay,"MiddleScrollOption","updateDisplay",0x8079e302,"MiddleScrollOption.updateDisplay","Options.hx",1552,0x9d9a0240)

void MiddleScrollOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_0223c7916a99f2e4_1527_new)
HXLINE(1528)		super::__construct();
HXLINE(1529)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1530)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE(1532)			this->description = desc;
            		}
            	}
...
bool MiddleScrollOption_obj::left(){
            	HX_STACKFRAME(&_hx_pos_0223c7916a99f2e4_1536_left)
HXLINE(1537)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1538)			return false;
            		}
HXLINE(1539)		::flixel::FlxG_obj::save->data->__SetField(HX_("middleScroll",42,cd,58,62),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("middleScroll",42,cd,58,62),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(1540)		this->display = this->updateDisplay();
HXLINE(1541)		return true;
            	}


bool MiddleScrollOption_obj::right(){
            	HX_STACKFRAME(&_hx_pos_0223c7916a99f2e4_1545_right)
HXLINE(1546)		this->left();
HXLINE(1547)		return true;
            	}


::String MiddleScrollOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_0223c7916a99f2e4_1552_updateDisplay)
HXDLIN(1552)		::String _hx_tmp;
HXDLIN(1552)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("middleScroll",42,cd,58,62),::hx::paccDynamic)) )) {
HXDLIN(1552)			_hx_tmp = HX_("Enabled",61,2c,82,4b);
            		}
            		else {
HXDLIN(1552)			_hx_tmp = HX_("Disabled",9c,fd,b5,55);
            		}
HXDLIN(1552)		return ((HX_("Middle Scroll: < ",02,de,a4,bd) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
