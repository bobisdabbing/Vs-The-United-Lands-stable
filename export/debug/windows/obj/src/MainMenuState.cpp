...
HXLINE(  30)		this->optionShit = ::Array_obj< ::String >::fromData( _hx_array_data_205e8859_1,3);
...
HXLINE(  52)		::haxe::Log_obj::trace(((Float)0.),::hx::SourceInfo(HX_("source/MainMenuState.hx",f9,ee,86,cf),52,HX_("MainMenuState",59,88,5e,20),HX_("create",fc,66,0f,7c)));
