...
HX_DEFINE_STACK_FRAME(_hx_pos_59e1436159e1af96_903_new,"FlashingLightsOption","new",0xa84c7996,"FlashingLightsOption.new","Options.hx",903,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_912_left,"FlashingLightsOption","left",0x994b6e11,"FlashingLightsOption.left","Options.hx",912,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_921_right,"FlashingLightsOption","right",0xffc1ee92,"FlashingLightsOption.right","Options.hx",921,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_59e1436159e1af96_928_updateDisplay,"FlashingLightsOption","updateDisplay",0xd86917ef,"FlashingLightsOption.updateDisplay","Options.hx",928,0x9d9a0240)

void FlashingLightsOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_903_new)
HXLINE( 904)		super::__construct();
HXLINE( 905)		if (::OptionsMenu_obj::isInPause) {
HXLINE( 906)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE( 908)			this->description = desc;
            		}
            	}
...
bool FlashingLightsOption_obj::left(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_912_left)
HXLINE( 913)		if (::OptionsMenu_obj::isInPause) {
HXLINE( 914)			return false;
            		}
HXLINE( 915)		::flixel::FlxG_obj::save->data->__SetField(HX_("flashing",32,85,e8,99),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 916)		this->display = this->updateDisplay();
HXLINE( 917)		return true;
            	}


bool FlashingLightsOption_obj::right(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_921_right)
HXLINE( 922)		this->left();
HXLINE( 923)		return true;
            	}


::String FlashingLightsOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_59e1436159e1af96_928_updateDisplay)
HXDLIN( 928)		::String _hx_tmp;
HXDLIN( 928)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("flashing",32,85,e8,99),::hx::paccDynamic)) ))) {
HXDLIN( 928)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 928)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 928)		return ((HX_("Flashing Lights: < ",15,22,a7,66) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
