...
HX_DEFINE_STACK_FRAME(_hx_pos_01e1add64facc2ce_1495_new,"JudgementCounter","new",0x70de7759,"JudgementCounter.new","Options.hx",1495,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_01e1add64facc2ce_1504_left,"JudgementCounter","left",0x50777aee,"JudgementCounter.left","Options.hx",1504,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_01e1add64facc2ce_1513_right,"JudgementCounter","right",0x8f212315,"JudgementCounter.right","Options.hx",1513,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_01e1add64facc2ce_1520_updateDisplay,"JudgementCounter","updateDisplay",0x59a50772,"JudgementCounter.updateDisplay","Options.hx",1520,0x9d9a0240)

void JudgementCounter_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_01e1add64facc2ce_1495_new)
HXLINE(1496)		super::__construct();
HXLINE(1497)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1498)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE(1500)			this->description = desc;
            		}
            	}
...
bool JudgementCounter_obj::left(){
            	HX_STACKFRAME(&_hx_pos_01e1add64facc2ce_1504_left)
HXLINE(1505)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1506)			return false;
            		}
HXLINE(1507)		::flixel::FlxG_obj::save->data->__SetField(HX_("judgementCounter",c7,fa,f4,d2),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("judgementCounter",c7,fa,f4,d2),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(1508)		this->display = this->updateDisplay();
HXLINE(1509)		return true;
            	}


bool JudgementCounter_obj::right(){
            	HX_STACKFRAME(&_hx_pos_01e1add64facc2ce_1513_right)
HXLINE(1514)		this->left();
HXLINE(1515)		return true;
            	}


::String JudgementCounter_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_01e1add64facc2ce_1520_updateDisplay)
HXDLIN(1520)		::String _hx_tmp;
HXDLIN(1520)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("judgementCounter",c7,fa,f4,d2),::hx::paccDynamic)) )) {
HXDLIN(1520)			_hx_tmp = HX_("Enabled",61,2c,82,4b);
            		}
            		else {
HXDLIN(1520)			_hx_tmp = HX_("Disabled",9c,fd,b5,55);
            		}
HXDLIN(1520)		return ((HX_("Judgement Counter: < ",5b,fd,d9,5b) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
