...
HX_DEFINE_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_1310_new,"CustomizeGameplay","new",0xb144179b,"CustomizeGameplay.new","Options.hx",1310,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_1319_press,"CustomizeGameplay","press",0xcb851f7e,"CustomizeGameplay.press","Options.hx",1319,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e4b4f5f29184daa6_1329_updateDisplay,"CustomizeGameplay","updateDisplay",0x26aa4e34,"CustomizeGameplay.updateDisplay","Options.hx",1329,0x9d9a0240)

void CustomizeGameplay_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_1310_new)
HXLINE(1311)		super::__construct();
HXLINE(1312)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1313)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE(1315)			this->description = desc;
            		}
            	}
...
bool CustomizeGameplay_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_1319_press)
HXLINE(1320)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1321)			return false;
            		}
HXLINE(1322)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),1322,HX_("CustomizeGameplay",29,ae,ab,0c),HX_("press",83,53,88,c8)));
HXLINE(1323)		{
HXLINE(1323)			 ::flixel::FlxState nextState =  ::GameplayCustomizeState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(1323)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(1323)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String CustomizeGameplay_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_e4b4f5f29184daa6_1329_updateDisplay)
HXDLIN(1329)		return HX_("Customize Gameplay",a3,2e,c4,04);
            	}
