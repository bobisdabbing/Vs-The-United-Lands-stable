...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_608_removeKeyboard,"Controls","removeKeyboard",0xd2dac3e3,"Controls.removeKeyboard","Controls.hx",608,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_621_addGamepad,"Controls","addGamepad",0xa2c68b58,"Controls.addGamepad","Controls.hx",621,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_637_addGamepadLiteral,"Controls","addGamepadLiteral",0x50b4e0f7,"Controls.addGamepadLiteral","Controls.hx",637,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_650_removeGamepad,"Controls","removeGamepad",0xfdf294e5,"Controls.removeGamepad","Controls.hx",650,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_668_addDefaultGamepad,"Controls","addDefaultGamepad",0xaa5e6409,"Controls.addDefaultGamepad","Controls.hx",668,0x0ab041e8)
...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_702_bindButtons,"Controls","bindButtons",0x94dee42c,"Controls.bindButtons","Controls.hx",702,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_715_unbindButtons,"Controls","unbindButtons",0x83d33473,"Controls.unbindButtons","Controls.hx",715,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_739_getInputsFor,"Controls","getInputsFor",0xa3571ac2,"Controls.getInputsFor","Controls.hx",739,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_763_removeDevice,"Controls","removeDevice",0x4c1b5cd2,"Controls.removeDevice","Controls.hx",763,0x0ab041e8)
...
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_723_addButtons,"Controls","addButtons",0xe3b5fcf8,"Controls.addButtons","Controls.hx",723,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_728_removeButtons,"Controls","removeButtons",0x3ee20685,"Controls.removeButtons","Controls.hx",728,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_774_isDevice,"Controls","isDevice",0xe09e10f8,"Controls.isDevice","Controls.hx",774,0x0ab041e8)
HX_LOCAL_STACK_FRAME(_hx_pos_948b5caa279cd923_783_isGamepad,"Controls","isGamepad",0x5bcd81ff,"Controls.isGamepad","Controls.hx",783,0x0ab041e8)
...
HXLINE( 596)		{
HXLINE( 596)			::Array< int > keys8 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_191,3);
...
HXLINE( 597)		{
HXLINE( 597)			::Array< int > keys9 = ::Array_obj< int >::fromData( _hx_array_data_116e4296_192,2);
...
HXLINE( 601)		::String s6 = ( (::String)(::flixel::FlxG_obj::save->data->__Field(HX_("muteBind",36,71,98,10),::hx::paccDynamic)) );
HXDLIN( 601)		s6 = s6.toUpperCase();
HXDLIN( 601)		int _hx_tmp;
HXDLIN( 601)		if (::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->exists(s6)) {
HXLINE( 601)			_hx_tmp = ::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->get_int(s6);
            		}
            		else {
HXLINE( 601)			_hx_tmp = -1;
            		}
HXDLIN( 601)		::flixel::FlxG_obj::sound->muteKeys = ::Array_obj< int >::__new(1)->init(0,_hx_tmp);
HXLINE( 602)		::String s7 = ( (::String)(::flixel::FlxG_obj::save->data->__Field(HX_("volDownBind",72,65,58,14),::hx::paccDynamic)) );
HXDLIN( 602)		s7 = s7.toUpperCase();
HXDLIN( 602)		int _hx_tmp1;
HXDLIN( 602)		if (::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->exists(s7)) {
HXLINE( 602)			_hx_tmp1 = ::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->get_int(s7);
            		}
            		else {
HXLINE( 602)			_hx_tmp1 = -1;
            		}
HXDLIN( 602)		::flixel::FlxG_obj::sound->volumeDownKeys = ::Array_obj< int >::__new(1)->init(0,_hx_tmp1);
HXLINE( 603)		::String s8 = ( (::String)(::flixel::FlxG_obj::save->data->__Field(HX_("volUpBind",2b,c1,5a,38),::hx::paccDynamic)) );
HXDLIN( 603)		s8 = s8.toUpperCase();
HXDLIN( 603)		int _hx_tmp2;
HXDLIN( 603)		if (::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->exists(s8)) {
HXLINE( 603)			_hx_tmp2 = ::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->get_int(s8);
            		}
            		else {
HXLINE( 603)			_hx_tmp2 = -1;
            		}
HXDLIN( 603)		::flixel::FlxG_obj::sound->volumeUpKeys = ::Array_obj< int >::__new(1)->init(0,_hx_tmp2);
            	}
...
void Controls_obj::removeKeyboard(){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_608_removeKeyboard)
HXDLIN( 608)		int _g = 0;
HXDLIN( 608)		::Array< ::Dynamic> _g1 = this->digitalActions;
HXDLIN( 608)		while((_g < _g1->length)){
HXDLIN( 608)			 ::flixel::input::actions::FlxActionDigital action = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionDigital >();
HXDLIN( 608)			_g = (_g + 1);
HXLINE( 610)			int i = action->inputs->length;
HXLINE( 611)			while(true){
HXLINE( 611)				i = (i - 1);
HXDLIN( 611)				if (!(((i + 1) > 0))) {
HXLINE( 611)					goto _hx_goto_194;
            				}
...
HXLINE( 614)				if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
...
void Controls_obj::addGamepad(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_621_addGamepad)
HXLINE( 622)		if (this->gamepadsAdded->contains(id)) {
HXLINE( 623)			this->gamepadsAdded->remove(id);
            		}
HXLINE( 625)		this->gamepadsAdded->push(id);
HXLINE( 628)		{
HXLINE( 628)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,buttonMap);
HXDLIN( 628)			while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 628)				 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 628)				 ::Control control = _g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 628)				::Array< int > buttons = ( (::Array< int >)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 629)				{
HXLINE( 629)					int id1 = id;
HXDLIN( 629)					::Array< int > buttons1 = buttons;
HXDLIN( 629)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXLINE( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 629)								int state = 1;
HXDLIN( 629)								int _g = 0;
HXDLIN( 629)								while((_g < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g);
HXDLIN( 629)									_g = (_g + 1);
HXDLIN( 629)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 629)								int state1 = 2;
HXDLIN( 629)								int _g1 = 0;
HXDLIN( 629)								while((_g1 < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g1);
HXDLIN( 629)									_g1 = (_g1 + 1);
HXDLIN( 629)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 629)								int state2 = -1;
HXDLIN( 629)								int _g2 = 0;
HXDLIN( 629)								while((_g2 < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g2);
HXDLIN( 629)									_g2 = (_g2 + 1);
HXDLIN( 629)									action2->addGamepad(button,state2,id1);
            								}
            							}
            						}
            						break;
            						case (int)1: {
HXLINE( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 629)								int state = 1;
HXDLIN( 629)								int _g = 0;
HXDLIN( 629)								while((_g < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g);
...
HXDLIN( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 629)								int state1 = 2;
HXDLIN( 629)								int _g1 = 0;
HXDLIN( 629)								while((_g1 < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g1);
...
HXDLIN( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 629)								int state2 = -1;
HXDLIN( 629)								int _g2 = 0;
HXDLIN( 629)								while((_g2 < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g2);
...
HXDLIN( 629)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)2: {
HXLINE( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 629)								int state = 1;
HXDLIN( 629)								int _g = 0;
HXDLIN( 629)								while((_g < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g);
...
HXDLIN( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 629)								int state1 = 2;
HXDLIN( 629)								int _g1 = 0;
HXDLIN( 629)								while((_g1 < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g1);
...
HXDLIN( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 629)								int state2 = -1;
HXDLIN( 629)								int _g2 = 0;
HXDLIN( 629)								while((_g2 < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g2);
...
HXDLIN( 629)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)3: {
HXLINE( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 629)								int state = 1;
HXDLIN( 629)								int _g = 0;
HXDLIN( 629)								while((_g < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g);
...
HXDLIN( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 629)								int state1 = 2;
HXDLIN( 629)								int _g1 = 0;
HXDLIN( 629)								while((_g1 < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g1);
...
HXDLIN( 629)							{
HXLINE( 629)								 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 629)								int state2 = -1;
HXDLIN( 629)								int _g2 = 0;
HXDLIN( 629)								while((_g2 < buttons1->length)){
HXLINE( 629)									int button = buttons1->__get(_g2);
...
HXDLIN( 629)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)8: {
HXLINE( 629)							 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 629)							int state = 2;
HXDLIN( 629)							int _g = 0;
HXDLIN( 629)							while((_g < buttons1->length)){
HXLINE( 629)								int button = buttons1->__get(_g);
...
void Controls_obj::addGamepadLiteral(int id, ::haxe::ds::EnumValueMap buttonMap){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_637_addGamepadLiteral)
HXLINE( 638)		this->gamepadsAdded->push(id);
HXLINE( 641)		{
HXLINE( 641)			 ::Dynamic _g =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,buttonMap);
HXDLIN( 641)			while(( (bool)(_g->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 641)				 ::Dynamic _g1 = _g->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 641)				 ::Control control = _g1->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 641)				::Array< int > buttons = ( (::Array< int >)(_g1->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXLINE( 642)				{
HXLINE( 642)					int id1 = id;
HXDLIN( 642)					::Array< int > buttons1 = buttons;
HXDLIN( 642)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXLINE( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 642)								int state = 1;
HXDLIN( 642)								int _g = 0;
HXDLIN( 642)								while((_g < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g);
HXDLIN( 642)									_g = (_g + 1);
HXDLIN( 642)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 642)								int state1 = 2;
HXDLIN( 642)								int _g1 = 0;
HXDLIN( 642)								while((_g1 < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g1);
HXDLIN( 642)									_g1 = (_g1 + 1);
HXDLIN( 642)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 642)								int state2 = -1;
HXDLIN( 642)								int _g2 = 0;
HXDLIN( 642)								while((_g2 < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g2);
HXDLIN( 642)									_g2 = (_g2 + 1);
HXDLIN( 642)									action2->addGamepad(button,state2,id1);
            								}
            							}
            						}
            						break;
            						case (int)1: {
HXLINE( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 642)								int state = 1;
HXDLIN( 642)								int _g = 0;
HXDLIN( 642)								while((_g < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g);
...
HXDLIN( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 642)								int state1 = 2;
HXDLIN( 642)								int _g1 = 0;
HXDLIN( 642)								while((_g1 < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g1);
...
HXDLIN( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 642)								int state2 = -1;
HXDLIN( 642)								int _g2 = 0;
HXDLIN( 642)								while((_g2 < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g2);
...
HXDLIN( 642)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)2: {
HXLINE( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 642)								int state = 1;
HXDLIN( 642)								int _g = 0;
HXDLIN( 642)								while((_g < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g);
...
HXDLIN( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 642)								int state1 = 2;
HXDLIN( 642)								int _g1 = 0;
HXDLIN( 642)								while((_g1 < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g1);
...
HXDLIN( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 642)								int state2 = -1;
HXDLIN( 642)								int _g2 = 0;
HXDLIN( 642)								while((_g2 < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g2);
...
HXDLIN( 642)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)3: {
HXLINE( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 642)								int state = 1;
HXDLIN( 642)								int _g = 0;
HXDLIN( 642)								while((_g < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g);
...
HXDLIN( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 642)								int state1 = 2;
HXDLIN( 642)								int _g1 = 0;
HXDLIN( 642)								while((_g1 < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g1);
...
HXDLIN( 642)							{
HXLINE( 642)								 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 642)								int state2 = -1;
HXDLIN( 642)								int _g2 = 0;
HXDLIN( 642)								while((_g2 < buttons1->length)){
HXLINE( 642)									int button = buttons1->__get(_g2);
...
HXDLIN( 642)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)8: {
HXLINE( 642)							 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 642)							int state = 2;
HXDLIN( 642)							int _g = 0;
HXDLIN( 642)							while((_g < buttons1->length)){
HXLINE( 642)								int button = buttons1->__get(_g);
...
void Controls_obj::removeGamepad(::hx::Null< int >  __o_deviceID){
            	...
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_650_removeGamepad)
HXLINE( 651)		{
HXLINE( 651)			int _g = 0;
HXDLIN( 651)			::Array< ::Dynamic> _g1 = this->digitalActions;
HXDLIN( 651)			while((_g < _g1->length)){
HXLINE( 651)				 ::flixel::input::actions::FlxActionDigital action = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionDigital >();
HXDLIN( 651)				_g = (_g + 1);
HXLINE( 653)				int i = action->inputs->length;
HXLINE( 654)				while(true){
HXLINE( 654)					i = (i - 1);
HXDLIN( 654)					if (!(((i + 1) > 0))) {
HXLINE( 654)						goto _hx_goto_235;
            					}
HXLINE( 656)					 ::flixel::input::actions::FlxActionInput input = action->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXLINE( 657)					bool _hx_tmp;
HXDLIN( 657)					if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 657)						if ((deviceID != -1)) {
HXLINE( 657)							_hx_tmp = (input->deviceID == deviceID);
            						}
            						else {
...
HXLINE( 658)						action->remove(input,null());
            					}
            				}
            				_hx_goto_235:;
            			}
            		}
HXLINE( 662)		this->gamepadsAdded->remove(deviceID);
            	}
...
void Controls_obj::addDefaultGamepad(int id){
            	HX_GC_STACKFRAME(&_hx_pos_948b5caa279cd923_668_addDefaultGamepad)
HXDLIN( 668)		 ::haxe::ds::EnumValueMap _g =  ::haxe::ds::EnumValueMap_obj::__alloc( HX_CTX );
HXDLIN( 668)		_g->set(::Control_obj::ACCEPT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_256,1));
HXDLIN( 668)		_g->set(::Control_obj::BACK_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_257,1));
HXDLIN( 668)		_g->set(::Control_obj::UP_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_258,2));
HXDLIN( 668)		_g->set(::Control_obj::DOWN_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_259,2));
HXDLIN( 668)		_g->set(::Control_obj::LEFT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_260,2));
HXDLIN( 668)		_g->set(::Control_obj::RIGHT_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_261,2));
HXDLIN( 668)		_g->set(::Control_obj::PAUSE_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_262,1));
HXDLIN( 668)		_g->set(::Control_obj::RESET_dyn(),::Array_obj< int >::fromData( _hx_array_data_116e4296_263,1));
HXDLIN( 668)		this->gamepadsAdded->push(id);
HXDLIN( 668)		{
HXDLIN( 668)			 ::Dynamic _g1 =  ::haxe::iterators::MapKeyValueIterator_obj::__alloc( HX_CTX ,_g);
HXDLIN( 668)			while(( (bool)(_g1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 668)				 ::Dynamic _g = _g1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)();
HXDLIN( 668)				 ::Control control = _g->__Field(HX_("key",9f,89,51,00),::hx::paccDynamic);
HXDLIN( 668)				::Array< int > buttons = ( (::Array< int >)(_g->__Field(HX_("value",71,7f,b8,31),::hx::paccDynamic)) );
HXDLIN( 668)				{
HXDLIN( 668)					int id1 = id;
HXDLIN( 668)					::Array< int > buttons1 = buttons;
HXDLIN( 668)					switch((int)(control->_hx_getIndex())){
            						case (int)0: {
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 668)								int state = 1;
HXDLIN( 668)								int _g = 0;
HXDLIN( 668)								while((_g < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g);
HXDLIN( 668)									_g = (_g + 1);
HXDLIN( 668)									action->addGamepad(button,state,id1);
            								}
            							}
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 668)								int state1 = 2;
HXDLIN( 668)								int _g1 = 0;
HXDLIN( 668)								while((_g1 < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g1);
HXDLIN( 668)									_g1 = (_g1 + 1);
HXDLIN( 668)									action1->addGamepad(button,state1,id1);
            								}
            							}
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 668)								int state2 = -1;
HXDLIN( 668)								int _g2 = 0;
HXDLIN( 668)								while((_g2 < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g2);
HXDLIN( 668)									_g2 = (_g2 + 1);
HXDLIN( 668)									action2->addGamepad(button,state2,id1);
            								}
            							}
            						}
            						break;
            						case (int)1: {
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 668)								int state = 1;
HXDLIN( 668)								int _g = 0;
HXDLIN( 668)								while((_g < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g);
...
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 668)								int state1 = 2;
HXDLIN( 668)								int _g1 = 0;
HXDLIN( 668)								while((_g1 < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g1);
...
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 668)								int state2 = -1;
HXDLIN( 668)								int _g2 = 0;
HXDLIN( 668)								while((_g2 < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g2);
...
HXDLIN( 668)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)2: {
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 668)								int state = 1;
HXDLIN( 668)								int _g = 0;
HXDLIN( 668)								while((_g < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g);
...
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 668)								int state1 = 2;
HXDLIN( 668)								int _g1 = 0;
HXDLIN( 668)								while((_g1 < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g1);
...
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 668)								int state2 = -1;
HXDLIN( 668)								int _g2 = 0;
HXDLIN( 668)								while((_g2 < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g2);
...
HXDLIN( 668)									action2->addGamepad(button,state2,id1);
            						...
            						case (int)3: {
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 668)								int state = 1;
HXDLIN( 668)								int _g = 0;
HXDLIN( 668)								while((_g < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g);
...
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 668)								int state1 = 2;
HXDLIN( 668)								int _g1 = 0;
HXDLIN( 668)								while((_g1 < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g1);
...
HXDLIN( 668)							{
HXDLIN( 668)								 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 668)								int state2 = -1;
HXDLIN( 668)								int _g2 = 0;
HXDLIN( 668)								while((_g2 < buttons1->length)){
HXDLIN( 668)									int button = buttons1->__get(_g2);
...
HXDLIN( 668)									action2->addGamepad(button,state2,id1);
            						...
            						break;
            						case (int)4: {
HXDLIN( 668)							 ::flixel::input::actions::FlxActionDigital action = this->_reset;
...
HXDLIN( 668)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)5: {
HXDLIN( 668)							 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 668)							int state = 2;
HXDLIN( 668)							int _g = 0;
HXDLIN( 668)							while((_g < buttons1->length)){
HXDLIN( 668)								int button = buttons1->__get(_g);
...
HXDLIN( 668)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)6: {
HXDLIN( 668)							 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 668)							int state = 2;
HXDLIN( 668)							int _g = 0;
HXDLIN( 668)							while((_g < buttons1->length)){
HXDLIN( 668)								int button = buttons1->__get(_g);
...
HXDLIN( 668)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)7: {
HXDLIN( 668)							 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 668)							int state = 2;
HXDLIN( 668)							int _g = 0;
HXDLIN( 668)							while((_g < buttons1->length)){
HXDLIN( 668)								int button = buttons1->__get(_g);
...
HXDLIN( 668)								action->addGamepad(button,state,id1);
            						...
            						break;
            						case (int)8: {
HXDLIN( 668)							 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 668)							int state = 2;
HXDLIN( 668)							int _g = 0;
HXDLIN( 668)							while((_g < buttons1->length)){
HXDLIN( 668)								int button = buttons1->__get(_g);
...
void Controls_obj::bindButtons( ::Control control,int id,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_702_bindButtons)
HXDLIN( 702)		switch((int)(control->_hx_getIndex())){
            			case (int)0: {
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action = this->_up;
HXDLIN( 702)					int state = 1;
HXDLIN( 702)					int _g = 0;
HXDLIN( 702)					while((_g < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g);
HXDLIN( 702)						_g = (_g + 1);
HXDLIN( 702)						action->addGamepad(button,state,id);
            					}
            				}
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action1 = this->_upP;
HXDLIN( 702)					int state1 = 2;
HXDLIN( 702)					int _g1 = 0;
HXDLIN( 702)					while((_g1 < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g1);
HXDLIN( 702)						_g1 = (_g1 + 1);
HXDLIN( 702)						action1->addGamepad(button,state1,id);
            					}
            				}
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action2 = this->_upR;
HXDLIN( 702)					int state2 = -1;
HXDLIN( 702)					int _g2 = 0;
HXDLIN( 702)					while((_g2 < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g2);
HXDLIN( 702)						_g2 = (_g2 + 1);
HXDLIN( 702)						action2->addGamepad(button,state2,id);
            					}
            				}
            			}
            			break;
            			case (int)1: {
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action = this->_left;
HXDLIN( 702)					int state = 1;
HXDLIN( 702)					int _g = 0;
HXDLIN( 702)					while((_g < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g);
...
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action1 = this->_leftP;
HXDLIN( 702)					int state1 = 2;
HXDLIN( 702)					int _g1 = 0;
HXDLIN( 702)					while((_g1 < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g1);
...
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action2 = this->_leftR;
HXDLIN( 702)					int state2 = -1;
HXDLIN( 702)					int _g2 = 0;
HXDLIN( 702)					while((_g2 < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g2);
...
HXDLIN( 702)						action2->addGamepad(button,state2,id);
            			...
            			case (int)2: {
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action = this->_right;
HXDLIN( 702)					int state = 1;
HXDLIN( 702)					int _g = 0;
HXDLIN( 702)					while((_g < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g);
...
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action1 = this->_rightP;
HXDLIN( 702)					int state1 = 2;
HXDLIN( 702)					int _g1 = 0;
HXDLIN( 702)					while((_g1 < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g1);
...
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action2 = this->_rightR;
HXDLIN( 702)					int state2 = -1;
HXDLIN( 702)					int _g2 = 0;
HXDLIN( 702)					while((_g2 < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g2);
...
HXDLIN( 702)						action2->addGamepad(button,state2,id);
            			...
            			case (int)3: {
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action = this->_down;
HXDLIN( 702)					int state = 1;
HXDLIN( 702)					int _g = 0;
HXDLIN( 702)					while((_g < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g);
...
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action1 = this->_downP;
HXDLIN( 702)					int state1 = 2;
HXDLIN( 702)					int _g1 = 0;
HXDLIN( 702)					while((_g1 < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g1);
...
HXDLIN( 702)				{
HXDLIN( 702)					 ::flixel::input::actions::FlxActionDigital action2 = this->_downR;
HXDLIN( 702)					int state2 = -1;
HXDLIN( 702)					int _g2 = 0;
HXDLIN( 702)					while((_g2 < buttons->length)){
HXDLIN( 702)						int button = buttons->__get(_g2);
...
HXDLIN( 702)						action2->addGamepad(button,state2,id);
            			...
            			break;
            			case (int)4: {
HXDLIN( 702)				 ::flixel::input::actions::FlxActionDigital action = this->_reset;
HXDLIN( 702)				int state = 2;
HXDLIN( 702)				int _g = 0;
HXDLIN( 702)				while((_g < buttons->length)){
HXDLIN( 702)					int button = buttons->__get(_g);
HXDLIN( 702)					_g = (_g + 1);
HXDLIN( 702)					action->addGamepad(button,state,id);
            			...
            			break;
            			case (int)5: {
HXDLIN( 702)				 ::flixel::input::actions::FlxActionDigital action = this->_accept;
HXDLIN( 702)				int state = 2;
HXDLIN( 702)				int _g = 0;
HXDLIN( 702)				while((_g < buttons->length)){
HXDLIN( 702)					int button = buttons->__get(_g);
...
HXDLIN( 702)					action->addGamepad(button,state,id);
            			...
            			break;
            			case (int)6: {
HXDLIN( 702)				 ::flixel::input::actions::FlxActionDigital action = this->_back;
HXDLIN( 702)				int state = 2;
HXDLIN( 702)				int _g = 0;
HXDLIN( 702)				while((_g < buttons->length)){
HXDLIN( 702)					int button = buttons->__get(_g);
...
HXDLIN( 702)					action->addGamepad(button,state,id);
            			...
            			break;
            			case (int)7: {
HXDLIN( 702)				 ::flixel::input::actions::FlxActionDigital action = this->_pause;
HXDLIN( 702)				int state = 2;
HXDLIN( 702)				int _g = 0;
HXDLIN( 702)				while((_g < buttons->length)){
HXDLIN( 702)					int button = buttons->__get(_g);
...
HXDLIN( 702)					action->addGamepad(button,state,id);
            			...
            			break;
            			case (int)8: {
HXDLIN( 702)				 ::flixel::input::actions::FlxActionDigital action = this->_cheat;
HXDLIN( 702)				int state = 2;
HXDLIN( 702)				int _g = 0;
HXDLIN( 702)				while((_g < buttons->length)){
HXDLIN( 702)					int button = buttons->__get(_g);
...
void Controls_obj::unbindButtons( ::Control control,int gamepadID,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_715_unbindButtons)
HXDLIN( 715)		switch((int)(control->_hx_getIndex())){
            			case (int)0: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_up,gamepadID,buttons);
HXDLIN( 715)				::Controls_obj::removeButtons(this->_upP,gamepadID,buttons);
HXDLIN( 715)				::Controls_obj::removeButtons(this->_upR,gamepadID,buttons);
            			}
            			break;
            			case (int)1: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_left,gamepadID,buttons);
HXDLIN( 715)				::Controls_obj::removeButtons(this->_leftP,gamepadID,buttons);
HXDLIN( 715)				::Controls_obj::removeButtons(this->_leftR,gamepadID,buttons);
            			}
            			break;
            			case (int)2: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_right,gamepadID,buttons);
HXDLIN( 715)				::Controls_obj::removeButtons(this->_rightP,gamepadID,buttons);
HXDLIN( 715)				::Controls_obj::removeButtons(this->_rightR,gamepadID,buttons);
            			}
            			break;
            			case (int)3: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_down,gamepadID,buttons);
HXDLIN( 715)				::Controls_obj::removeButtons(this->_downP,gamepadID,buttons);
HXDLIN( 715)				::Controls_obj::removeButtons(this->_downR,gamepadID,buttons);
            			}
            			break;
            			case (int)4: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_reset,gamepadID,buttons);
            			}
            			break;
            			case (int)5: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_accept,gamepadID,buttons);
            			}
            			break;
            			case (int)6: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_back,gamepadID,buttons);
            			}
            			break;
            			case (int)7: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_pause,gamepadID,buttons);
            			}
            			break;
            			case (int)8: {
HXDLIN( 715)				::Controls_obj::removeButtons(this->_cheat,gamepadID,buttons);
            			}
            			break;
            		}
            	}
...
::Array< int > Controls_obj::getInputsFor( ::Control control, ::Device device,::Array< int > list){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_739_getInputsFor)
HXLINE( 740)		if (::hx::IsNull( list )) {
HXLINE( 741)			list = ::Array_obj< int >::__new(0);
            		}
HXLINE( 743)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 746)				int _g = 0;
HXDLIN( 746)				::Array< ::Dynamic> _g1 = this->getActionFromControl(control)->inputs;
HXDLIN( 746)				while((_g < _g1->length)){
HXLINE( 746)					 ::flixel::input::actions::FlxActionInput input = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXDLIN( 746)					_g = (_g + 1);
HXLINE( 748)					if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() )) {
HXLINE( 749)						list->push(input->inputID);
            					}
            				}
            			}
            			break;
            			case (int)1: {
HXLINE( 751)				int id = device->_hx_getInt(0);
HXLINE( 752)				{
HXLINE( 752)					int _g = 0;
HXDLIN( 752)					::Array< ::Dynamic> _g1 = this->getActionFromControl(control)->inputs;
HXDLIN( 752)					while((_g < _g1->length)){
HXLINE( 752)						 ::flixel::input::actions::FlxActionInput input = _g1->__get(_g).StaticCast<  ::flixel::input::actions::FlxActionInput >();
HXDLIN( 752)						_g = (_g + 1);
HXLINE( 754)						if ((input->deviceID == id)) {
HXLINE( 755)							list->push(input->inputID);
            						}
            					}
            				}
            			}
...
void Controls_obj::removeDevice( ::Device device){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_763_removeDevice)
HXDLIN( 763)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 766)				this->setKeyboardScheme(::KeyboardScheme_obj::None_dyn(),null());
            			}
            			break;
            			case (int)1: {
HXLINE( 767)				int id = device->_hx_getInt(0);
HXLINE( 768)				this->removeGamepad(id);
            			}
            			break;
            		}
            	}
...
void Controls_obj::addButtons( ::flixel::input::actions::FlxActionDigital action,::Array< int > buttons,int state,int id){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_723_addButtons)
HXDLIN( 723)		int _g = 0;
HXDLIN( 723)		while((_g < buttons->length)){
HXDLIN( 723)			int button = buttons->__get(_g);
HXDLIN( 723)			_g = (_g + 1);
HXLINE( 724)			action->addGamepad(button,state,id);
            		}
            	}
...
void Controls_obj::removeButtons( ::flixel::input::actions::FlxActionDigital action,int gamepadID,::Array< int > buttons){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_728_removeButtons)
HXLINE( 729)		int i = action->inputs->length;
HXLINE( 730)		while(true){
HXLINE( 730)			i = (i - 1);
HXDLIN( 730)			if (!(((i + 1) > 0))) {
HXLINE( 730)				goto _hx_goto_294;
            			}
HXLINE( 732)			 ::flixel::input::actions::FlxActionInput input = action->inputs->__get(i).StaticCast<  ::flixel::input::actions::FlxActionInput >();
...
HXLINE( 733)				if ((gamepadID != -1)) {
HXLINE( 733)					_hx_tmp1 = (input->deviceID == gamepadID);
            				}
            				else {
...
HXLINE( 733)				_hx_tmp = (buttons->indexOf(input->inputID,null()) != -1);
            			}
            			else {
HXLINE( 733)				_hx_tmp = false;
            			}
HXDLIN( 733)			if (_hx_tmp) {
HXLINE( 734)				action->remove(input,null());
            			}
            		}
            		_hx_goto_294:;
            	}
...
bool Controls_obj::isDevice( ::flixel::input::actions::FlxActionInput input, ::Device device){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_774_isDevice)
HXDLIN( 774)		switch((int)(device->_hx_getIndex())){
            			case (int)0: {
HXLINE( 776)				return ::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::KEYBOARD_dyn() );
            			}
            			break;
            			case (int)1: {
HXLINE( 777)				int id = device->_hx_getInt(0);
HXDLIN( 777)				if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXLINE( 777)					if ((id != -1)) {
HXLINE( 777)						return (input->deviceID == id);
            					}
            					else {
...
bool Controls_obj::isGamepad( ::flixel::input::actions::FlxActionInput input,int deviceID){
            	HX_STACKFRAME(&_hx_pos_948b5caa279cd923_783_isGamepad)
HXDLIN( 783)		if (::hx::IsEq( input->device,::flixel::input::actions::FlxInputDevice_obj::GAMEPAD_dyn() )) {
HXDLIN( 783)			if ((deviceID != -1)) {
HXDLIN( 783)				return (input->deviceID == deviceID);
            			}
            			else {
HXDLIN( 783)				return true;
            			}
            		}
            		else {
HXDLIN( 783)			return false;
            		}
HXDLIN( 783)		return false;
            	}
