...
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_55_updatePlayer,"WebmHandler","updatePlayer",0x6df7c187,"WebmHandler.updatePlayer","WebmHandler.hx",55,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_62_play,"WebmHandler","play",0xef155831,"WebmHandler.play","WebmHandler.hx",62,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_70_stop,"WebmHandler","stop",0xf1171a3f,"WebmHandler.stop","WebmHandler.hx",70,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_78_restart,"WebmHandler","restart",0x1812e1b2,"WebmHandler.restart","WebmHandler.hx",78,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_85_update,"WebmHandler","update",0x308d7986,"WebmHandler.update","WebmHandler.hx",85,0x2dcf8c0d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_112_togglePause,"WebmHandler","togglePause",0x0581d625,"WebmHandler.togglePause","WebmHandler.hx",112,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_123_clearPause,"WebmHandler","clearPause",0x63760c26,"WebmHandler.clearPause","WebmHandler.hx",123,0x2dcf8c0d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_144_onEnd,"WebmHandler","onEnd",0xb16e631f,"WebmHandler.onEnd","WebmHandler.hx",144,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_151_alpha,"WebmHandler","alpha",0xa0a07281,"WebmHandler.alpha","WebmHandler.hx",151,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_156_unalpha,"WebmHandler","unalpha",0xcb94b848,"WebmHandler.unalpha","WebmHandler.hx",156,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_161_hide,"WebmHandler","hide",0xe9c95eff,"WebmHandler.hide","WebmHandler.hx",161,0x2dcf8c0d)
HX_LOCAL_STACK_FRAME(_hx_pos_b6d9a5cb8ab7eda1_166_show,"WebmHandler","show",0xf10dff3a,"WebmHandler.show","WebmHandler.hx",166,0x2dcf8c0d)
...
void WebmHandler_obj::updatePlayer(){
            	HX_GC_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_55_updatePlayer)
HXLINE(  56)		this->io =  ::webm::WebmIoFile_obj::__alloc( HX_CTX ,this->vidPath);
HXLINE(  57)		this->webm->fuck(this->io,false);
            	}
...
void WebmHandler_obj::play(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_62_play)
HXDLIN(  62)		if (this->initialized) {
HXLINE(  64)			this->webm->play();
            		}
            	}
...
void WebmHandler_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_70_stop)
HXDLIN(  70)		if (this->initialized) {
HXLINE(  72)			this->webm->stop(null());
            		}
            	}
...
void WebmHandler_obj::restart(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_78_restart)
HXDLIN(  78)		if (this->initialized) {
HXLINE(  80)			this->webm->restart();
            		}
            	}
...
void WebmHandler_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_85_update)
HXLINE(  86)		 ::webm::WebmPlayer _hx_tmp = this->webm;
HXDLIN(  86)		_hx_tmp->set_x(( (Float)(::GlobalVideo_obj::calc(0)) ));
HXLINE(  87)		 ::webm::WebmPlayer _hx_tmp1 = this->webm;
HXDLIN(  87)		_hx_tmp1->set_y(( (Float)(::GlobalVideo_obj::calc(1)) ));
HXLINE(  88)		 ::webm::WebmPlayer _hx_tmp2 = this->webm;
HXDLIN(  88)		_hx_tmp2->set_width(( (Float)(::GlobalVideo_obj::calc(2)) ));
HXLINE(  89)		 ::webm::WebmPlayer _hx_tmp3 = this->webm;
HXDLIN(  89)		_hx_tmp3->set_height(( (Float)(::GlobalVideo_obj::calc(3)) ));
            	}
...
void WebmHandler_obj::togglePause(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_112_togglePause)
HXDLIN( 112)		if (this->paused) {
HXLINE( 114)			this->resume();
            		}
            		else {
HXLINE( 118)			this->pause();
            		}
            	}
...
void WebmHandler_obj::clearPause(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_123_clearPause)
HXLINE( 124)		this->paused = false;
HXLINE( 125)		this->webm->removePause();
            	}
...
void WebmHandler_obj::onEnd(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_144_onEnd)
HXLINE( 145)		::haxe::Log_obj::trace(HX_("IT ENDED!",9c,79,1b,cb),::hx::SourceInfo(HX_("source/WebmHandler.hx",01,5e,69,f7),145,HX_("WebmHandler",51,5f,03,d7),HX_("onEnd",fc,97,64,32)));
HXLINE( 146)		this->ended = true;
            	}
...
void WebmHandler_obj::alpha(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_151_alpha)
HXDLIN( 151)		this->webm->set_alpha(::GlobalVideo_obj::daAlpha1);
            	}
...
void WebmHandler_obj::unalpha(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_156_unalpha)
HXDLIN( 156)		this->webm->set_alpha(::GlobalVideo_obj::daAlpha2);
            	}
...
void WebmHandler_obj::hide(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_161_hide)
HXDLIN( 161)		this->webm->set_visible(false);
            	}
...
void WebmHandler_obj::show(){
            	HX_STACKFRAME(&_hx_pos_b6d9a5cb8ab7eda1_166_show)
HXDLIN( 166)		this->webm->set_visible(true);
            	}
