...
HXLINE(  96)		::haxe::Log_obj::trace( ::Dynamic((((HX_("conversion stuff ",76,b2,06,a1) + song->__Field(HX_("songId",10,c3,88,2d),::hx::paccDynamic)) + HX_(" ",20,00,00,00)) + ( (::Array< ::Dynamic>)(song->__Field(HX_("notes",41,dc,ca,9f),::hx::paccDynamic)) )->length)),::hx::SourceInfo(HX_("source/Song.hx",75,11,88,af),96,HX_("Song",f5,4f,31,37),HX_("conversionChecks",61,d2,b3,41)));
...
HXLINE( 163)					::haxe::Log_obj::trace((HX_("converting changebpm for section ",14,5f,9e,41) + index),::hx::SourceInfo(HX_("source/Song.hx",75,11,88,af),163,HX_("Song",f5,4f,31,37),HX_("conversionChecks",61,d2,b3,41)));
