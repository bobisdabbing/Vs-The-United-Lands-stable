...
HX_LOCAL_STACK_FRAME(_hx_pos_93698466c21ed147_16_GCD,"HelperFunctions","GCD",0xc8d3bca7,"HelperFunctions.GCD","HelperFunctions.hx",16,0xfb293df1)
...
int HelperFunctions_obj::GCD(int a,int b){
            	HX_STACKFRAME(&_hx_pos_93698466c21ed147_16_GCD)
HXDLIN(  16)		if ((b == 0)) {
HXDLIN(  16)			if ((a > 0)) {
HXDLIN(  16)				return a;
            			}
...
HXDLIN(  16)			return ::HelperFunctions_obj::GCD(b,::hx::Mod(a,b));
            		}
HXDLIN(  16)		return 0;
            	}
