...
HX_DEFINE_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_1081_new,"ScoreScreen","new",0x96db9c30,"ScoreScreen.new","Options.hx",1081,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_1087_press,"ScoreScreen","press",0xe976b353,"ScoreScreen.press","Options.hx",1087,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_2c43211bb2dff3c7_1095_updateDisplay,"ScoreScreen","updateDisplay",0x3fc33f09,"ScoreScreen.updateDisplay","Options.hx",1095,0x9d9a0240)

void ScoreScreen_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_1081_new)
HXLINE(1082)		super::__construct();
HXLINE(1083)		this->description = desc;
            	}
...
bool ScoreScreen_obj::press(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_1087_press)
HXLINE(1088)		::flixel::FlxG_obj::save->data->__SetField(HX_("scoreScreen",5e,6c,c3,13),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(1089)		this->display = this->updateDisplay();
HXLINE(1090)		return true;
            	}


::String ScoreScreen_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_2c43211bb2dff3c7_1095_updateDisplay)
HXDLIN(1095)		::String _hx_tmp;
HXDLIN(1095)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("scoreScreen",5e,6c,c3,13),::hx::paccDynamic)) )) {
HXDLIN(1095)			_hx_tmp = HX_("Enabled",61,2c,82,4b);
            		}
            		else {
HXDLIN(1095)			_hx_tmp = HX_("Disabled",9c,fd,b5,55);
            		}
HXDLIN(1095)		return ((HX_("Score Screen: < ",44,10,9c,61) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
