...
HXLINE( 431)				if (::hx::IsEq( ::flixel::FlxG_obj::cameras->list->__get(i).StaticCast<  ::flixel::FlxCamera >(),Camera )) {
...
HXDLIN( 546)						{
HXLINE( 546)							 ::flixel::math::FlxPoint _g = _this;
HXDLIN( 546)							_g->set_x((_g->x + buffer->x));
            						}
HXDLIN( 546)						{
HXLINE( 546)							 ::flixel::math::FlxPoint _g1 = _this;
HXDLIN( 546)							_g1->set_y((_g1->y + Y));
            						}
...
HXLINE( 691)								_hx_tmp = ::Std_obj::isOfType(Object,( ( ::Dynamic)(tile->filter) ));
            							}
            							else {
...
HXLINE( 727)			{
HXLINE( 727)				 ::flixel::math::FlxPoint _g = point1;
HXDLIN( 727)				_g->set_x((_g->x + (this->_scaledTileWidth * ((Float)0.5))));
            			}
HXLINE( 728)			{
HXLINE( 728)				 ::flixel::math::FlxPoint _g1 = point1;
HXDLIN( 728)				_g1->set_y((_g1->y + (this->_scaledTileHeight * ((Float)0.5))));
            			}
            		}
...
HXLINE( 755)						{
HXLINE( 755)							 ::flixel::math::FlxPoint _g = point;
HXDLIN( 755)							_g->set_x((_g->x + (this->_scaledTileWidth * ((Float)0.5))));
            						}
HXLINE( 756)						{
HXLINE( 756)							 ::flixel::math::FlxPoint _g1 = point;
HXDLIN( 756)							_g1->set_y((_g1->y + (this->_scaledTileHeight * ((Float)0.5))));
            						}
            					}
...
HXLINE(1076)							 ::openfl::geom::Point _hx_tmp = this->_flashPoint;
HXDLIN(1076)							_hx_tmp->x = (_hx_tmp->x + this->_tileWidth);
            						}
HXLINE(1078)						columnIndex = (columnIndex + 1);
            					}
            				}
HXLINE(1081)				if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1082)					 ::openfl::geom::Point _hx_tmp = this->_flashPoint;
HXDLIN(1082)					_hx_tmp->y = (_hx_tmp->y + this->_tileHeight);
            				}
...
HXLINE(1173)		if (::hx::IsNotEq( this->graphic,Value )) {
HXLINE(1176)			if (::hx::IsNotNull( Value )) {
HXLINE(1177)				 ::flixel::graphics::FlxGraphic _g = Value;
HXDLIN(1177)				_g->set_useCount((_g->get_useCount() + 1));
            			}
HXLINE(1180)			if (::hx::IsNotNull( this->graphic )) {
HXLINE(1181)				 ::flixel::graphics::FlxGraphic _g = this->graphic;
HXDLIN(1181)				_g->set_useCount((_g->get_useCount() - 1));
            			}
            		}
