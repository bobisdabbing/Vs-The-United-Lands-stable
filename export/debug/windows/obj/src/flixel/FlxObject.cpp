...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1110_drawDebug,"flixel.FlxObject","drawDebug",0x2ad45ea0,"flixel.FlxObject.drawDebug","flixel/FlxObject.hx",1110,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1130_drawDebugOnCamera,"flixel.FlxObject","drawDebugOnCamera",0x0b2ef7e4,"flixel.FlxObject.drawDebugOnCamera","flixel/FlxObject.hx",1130,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1141_drawDebugBoundingBox,"flixel.FlxObject","drawDebugBoundingBox",0xa96b1247,"flixel.FlxObject.drawDebugBoundingBox","flixel/FlxObject.hx",1141,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1163_beginDrawDebug,"flixel.FlxObject","beginDrawDebug",0x8677cfb5,"flixel.FlxObject.beginDrawDebug","flixel/FlxObject.hx",1163,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1176_endDrawDebug,"flixel.FlxObject","endDrawDebug",0x2518e603,"flixel.FlxObject.endDrawDebug","flixel/FlxObject.hx",1176,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1226_set_width,"flixel.FlxObject","set_width",0x7d06d55a,"flixel.FlxObject.set_width","flixel/FlxObject.hx",1226,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1240_set_height,"flixel.FlxObject","set_height",0x9f435213,"flixel.FlxObject.set_height","flixel/FlxObject.hx",1240,0xf0fe0d80)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1311_set_debugBoundingBoxColorSolid,"flixel.FlxObject","set_debugBoundingBoxColorSolid",0xb8a23688,"flixel.FlxObject.set_debugBoundingBoxColorSolid","flixel/FlxObject.hx",1311,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1317_set_debugBoundingBoxColorNotSolid,"flixel.FlxObject","set_debugBoundingBoxColorNotSolid",0x55ae1bdb,"flixel.FlxObject.set_debugBoundingBoxColorNotSolid","flixel/FlxObject.hx",1317,0xf0fe0d80)
HX_LOCAL_STACK_FRAME(_hx_pos_c625bfaa5b4263df_1323_set_debugBoundingBoxColorPartial,"flixel.FlxObject","set_debugBoundingBoxColorPartial",0x34746b1e,"flixel.FlxObject.set_debugBoundingBoxColorPartial","flixel/FlxObject.hx",1323,0xf0fe0d80)
...
void FlxObject_obj::drawDebug(){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1110_drawDebug)
HXLINE(1111)		if (this->ignoreDrawDebug) {
HXLINE(1112)			return;
            		}
HXLINE(1114)		{
HXLINE(1114)			int _g = 0;
HXDLIN(1114)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN(1114)			while((_g < _g1->length)){
HXLINE(1114)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(1114)				_g = (_g + 1);
HXLINE(1116)				this->drawDebugOnCamera(camera);
HXLINE(1118)				bool _hx_tmp;
HXDLIN(1118)				if (::hx::IsNotNull( this->path )) {
HXLINE(1118)					_hx_tmp = !(this->path->ignoreDrawDebug);
            				}
            				else {
HXLINE(1118)					_hx_tmp = false;
            				}
HXDLIN(1118)				if (_hx_tmp) {
HXLINE(1119)					this->path->drawDebug(null());
            				}
            			}
            		}
            	}
...
void FlxObject_obj::drawDebugOnCamera( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1130_drawDebugOnCamera)
HXLINE(1131)		bool _hx_tmp;
HXDLIN(1131)		bool _hx_tmp1;
HXDLIN(1131)		if (camera->visible) {
HXLINE(1131)			_hx_tmp1 = !(camera->exists);
            		}
            		else {
HXLINE(1131)			_hx_tmp1 = true;
            		}
HXDLIN(1131)		if (!(_hx_tmp1)) {
HXLINE(1131)			_hx_tmp = !(this->isOnScreen(camera));
            		}
            		else {
...
HXLINE(1134)		 ::flixel::math::FlxRect rect = this->getBoundingBox(camera);
HXLINE(1135)		 ::openfl::display::Graphics gfx;
HXDLIN(1135)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1135)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXDLIN(1135)			gfx = ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1135)			gfx = camera->debugLayer->get_graphics();
            		}
HXLINE(1136)		this->drawDebugBoundingBox(gfx,rect,this->allowCollisions,this->immovable);
HXLINE(1137)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1137)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
void FlxObject_obj::drawDebugBoundingBox( ::openfl::display::Graphics gfx, ::flixel::math::FlxRect rect,int allowCollisions,bool partial){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1141_drawDebugBoundingBox)
HXLINE(1143)		 ::Dynamic color = this->debugBoundingBoxColor;
HXLINE(1144)		if (::hx::IsNull( color )) {
HXLINE(1146)			if ((allowCollisions != 0)) {
HXLINE(1148)				if (partial) {
HXLINE(1148)					color = this->debugBoundingBoxColorPartial;
            				}
            				else {
HXLINE(1148)					color = this->debugBoundingBoxColorSolid;
            				}
            			}
            			else {
HXLINE(1152)				color = this->debugBoundingBoxColorNotSolid;
            			}
            		}
HXLINE(1157)		gfx->lineStyle(1,color,((Float)0.5),null(),null(),null(),null(),null());
HXLINE(1158)		gfx->drawRect(rect->x,rect->y,rect->width,rect->height);
            	}
...
HX_DEFINE_DYNAMIC_FUNC4(FlxObject_obj,drawDebugBoundingBox,(void))
 ...
 ::openfl::display::Graphics FlxObject_obj::beginDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1163_beginDrawDebug)
HXDLIN(1163)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1165)			::flixel::util::FlxSpriteUtil_obj::flashGfx->clear();
HXLINE(1166)			return ::flixel::util::FlxSpriteUtil_obj::flashGfx;
            		}
            		else {
HXLINE(1170)			return camera->debugLayer->get_graphics();
            		}
...
void FlxObject_obj::endDrawDebug( ::flixel::FlxCamera camera){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1176_endDrawDebug)
HXDLIN(1176)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(1177)			camera->buffer->draw(::flixel::util::FlxSpriteUtil_obj::flashGfxSprite,null(),null(),null(),null(),null());
            		}
            	}
...
Float FlxObject_obj::set_width(Float Width){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1226_set_width)
HXLINE(1228)		if ((Width < 0)) {
HXLINE(1230)			::flixel::FlxG_obj::log->advanced(HX_("An object's width cannot be smaller than 0. Use offset for sprites to control the hitbox position!",f5,8d,0b,95),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(1231)			return Width;
            		}
HXLINE(1235)		return (this->width = Width);
            	}
...
Float FlxObject_obj::set_height(Float Height){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1240_set_height)
HXLINE(1242)		if ((Height < 0)) {
HXLINE(1244)			::flixel::FlxG_obj::log->advanced(HX_("An object's height cannot be smaller than 0. Use offset for sprites to control the hitbox position!",b0,49,90,e4),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
HXLINE(1245)			return Height;
            		}
HXLINE(1249)		return (this->height = Height);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1311_set_debugBoundingBoxColorSolid)
HXDLIN(1311)		return (this->debugBoundingBoxColorSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorNotSolid(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1317_set_debugBoundingBoxColorNotSolid)
HXDLIN(1317)		return (this->debugBoundingBoxColorNotSolid = color);
            	}
...
int FlxObject_obj::set_debugBoundingBoxColorPartial(int color){
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_1323_set_debugBoundingBoxColorPartial)
HXDLIN(1323)		return (this->debugBoundingBoxColorPartial = color);
            	}
