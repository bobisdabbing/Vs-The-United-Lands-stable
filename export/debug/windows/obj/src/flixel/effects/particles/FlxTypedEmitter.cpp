...
HXLINE( 442)			if (::hx::IsEq( this->launchMode,::flixel::effects::particles::FlxEmitterMode_obj::CIRCLE_dyn() )) {
...
HXLINE( 472)			_hx_tmp = ::hx::IsNotEq( this->angularVelocity->start,this->angularVelocity->end );
            		}
            		else {
