...
HXLINE( 422)			{
HXLINE( 422)				 ::flixel::_hx_system::debug::stats::Stats _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 422)				_g->set_x((_g->get_x() - ( (Float)(160) )));
            			}
...
HXLINE( 430)			{
HXLINE( 430)				 ::flixel::_hx_system::debug::stats::Stats _g = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 430)				_g->set_x((_g->get_x() + 160));
            			}
