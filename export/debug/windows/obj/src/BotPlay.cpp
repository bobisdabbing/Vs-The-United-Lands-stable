...
HXLINE(1445)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(1445)		::String _hx_tmp1 = (HX_("BotPlay : ",2b,ca,ec,4b) + ::Std_obj::string( ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("botplay",7b,fb,a9,61),::hx::paccDynamic))));
HXDLIN(1445)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),1445,HX_("BotPlay",7b,4f,d4,19),HX_("left",07,08,b0,47)));
