...
HX_LOCAL_STACK_FRAME(_hx_pos_4c95a0630eaf1443_87_reType,"Alphabet","reType",0x30c60648,"Alphabet.reType","Alphabet.hx",87,0xc2e40fcb)
...
HX_LOCAL_STACK_FRAME(_hx_pos_4c95a0630eaf1443_290_resizeText,"Alphabet","resizeText",0x7343c47c,"Alphabet.resizeText","Alphabet.hx",290,0xc2e40fcb)
HX_LOCAL_STACK_FRAME(_hx_pos_4c95a0630eaf1443_313_moveTextToMidpoint,"Alphabet","moveTextToMidpoint",0x748e631c,"Alphabet.moveTextToMidpoint","Alphabet.hx",313,0xc2e40fcb)
...
HXLINE( 169)		this->personTalking = HX_("gf",1f,5a,00,00);
...
void Alphabet_obj::reType(::String text,::hx::Null< Float >  __o_xScale,::hx::Null< Float >  __o_yScale){
            		Float xScale = __o_xScale.Default(1);
            		Float yScale = __o_yScale.Default(1);
            	HX_STACKFRAME(&_hx_pos_4c95a0630eaf1443_87_reType)
HXLINE(  88)		{
HXLINE(  88)			 ::haxe::ds::_List::ListNode _g_head = this->listOAlphabets->h;
HXDLIN(  88)			while(::hx::IsNotNull( _g_head )){
HXLINE(  88)				 ::AlphaCharacter val = ( ( ::AlphaCharacter)(_g_head->item) );
HXDLIN(  88)				_g_head = _g_head->next;
HXDLIN(  88)				 ::AlphaCharacter i = val;
HXLINE(  89)				this->remove(i,null());
            			}
            		}
HXLINE(  90)		this->_finalText = text;
HXLINE(  91)		this->text = text;
HXLINE(  93)		this->lastSprite = null();
HXLINE(  95)		this->updateHitbox();
HXLINE(  97)		this->listOAlphabets->clear();
HXLINE(  98)		this->set_x(this->pastX);
HXLINE(  99)		this->set_y(this->pastY);
HXLINE( 101)		this->xScale = xScale;
HXLINE( 102)		this->yScale = yScale;
HXLINE( 104)		this->addText();
            	}
...
HXLINE( 179)		::Array< int > loopNum = ::Array_obj< int >::fromData( _hx_array_data_faea38d3_8,1);
HXLINE( 181)		::Array< Float > xPos = ::Array_obj< Float >::fromData( _hx_array_data_faea38d3_9,1);
HXLINE( 182)		::Array< int > curRow = ::Array_obj< int >::fromData( _hx_array_data_faea38d3_10,1);
...
void Alphabet_obj::resizeText(Float xScale,Float yScale,::hx::Null< bool >  __o_xStaysCentered,::hx::Null< bool >  __o_yStaysCentered){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_4c95a0630eaf1443_290_resizeText)
HXLINE( 291)		 ::flixel::math::FlxPoint oldMidpoint = this->getMidpoint(null());
HXLINE( 292)		this->reType(this->text,xScale,yScale);
HXLINE( 293)		bool _hx_tmp;
HXDLIN( 293)		if (xStaysCentered) {
HXLINE( 293)			_hx_tmp = yStaysCentered;
            		}
            		else {
HXLINE( 293)			_hx_tmp = false;
            		}
HXDLIN( 293)		if (!(_hx_tmp)) {
HXLINE( 295)			if (xStaysCentered) {
HXLINE( 298)				Float oldMidpoint1 = oldMidpoint->x;
HXDLIN( 298)				this->moveTextToMidpoint( ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,oldMidpoint1,this->getMidpoint(null())->y));
            			}
HXLINE( 300)			if (yStaysCentered) {
HXLINE( 302)				this->moveTextToMidpoint( ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,this->getMidpoint(null())->x,oldMidpoint->y));
            			}
            		}
            		else {
HXLINE( 307)			this->moveTextToMidpoint( ::flixel::math::FlxPoint_obj::__alloc( HX_CTX ,oldMidpoint->x,oldMidpoint->y));
            		}
            	}
...
void Alphabet_obj::moveTextToMidpoint( ::flixel::math::FlxPoint midpoint){
            	HX_STACKFRAME(&_hx_pos_4c95a0630eaf1443_313_moveTextToMidpoint)
HXLINE( 319)		Float midpoint1 = midpoint->x;
HXDLIN( 319)		this->set_x((midpoint1 - (this->get_width() / ( (Float)(2) ))));
HXLINE( 320)		Float midpoint2 = midpoint->y;
HXDLIN( 320)		this->set_y((midpoint2 - (this->get_height() / ( (Float)(2) ))));
            	}
