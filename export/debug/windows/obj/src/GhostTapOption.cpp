...
HX_DEFINE_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_674_new,"GhostTapOption","new",0x6c686a7b,"GhostTapOption.new","Options.hx",674,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_680_left,"GhostTapOption","left",0x6da2458c,"GhostTapOption.left","Options.hx",680,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_687_right,"GhostTapOption","right",0xf767a2b7,"GhostTapOption.right","Options.hx",687,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_72f1a114c5fe7f32_694_updateDisplay,"GhostTapOption","updateDisplay",0xb7c6f914,"GhostTapOption.updateDisplay","Options.hx",694,0x9d9a0240)

void GhostTapOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_674_new)
HXLINE( 675)		super::__construct();
HXLINE( 676)		this->description = desc;
            	}
...
bool GhostTapOption_obj::left(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_680_left)
HXLINE( 681)		::flixel::FlxG_obj::save->data->__SetField(HX_("ghost",4f,8f,58,93),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 682)		this->display = this->updateDisplay();
HXLINE( 683)		return true;
            	}


bool GhostTapOption_obj::right(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_687_right)
HXLINE( 688)		this->left();
HXLINE( 689)		return true;
            	}


::String GhostTapOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_72f1a114c5fe7f32_694_updateDisplay)
HXDLIN( 694)		::String _hx_tmp;
HXDLIN( 694)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("ghost",4f,8f,58,93),::hx::paccDynamic)) )) {
HXDLIN( 694)			_hx_tmp = HX_("Enabled",61,2c,82,4b);
            		}
            		else {
HXDLIN( 694)			_hx_tmp = HX_("Disabled",9c,fd,b5,55);
            		}
HXDLIN( 694)		return ((HX_("Ghost Tapping: < ",ce,ba,73,10) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
