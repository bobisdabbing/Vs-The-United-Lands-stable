...
HXLINE(  45)		::haxe::Log_obj::trace(this->controlsStrings,::hx::SourceInfo(HX_("source/LoadReplayState.hx",6e,34,7a,fb),45,HX_("LoadReplayState",c4,3c,20,8a),HX_("create",fc,66,0f,7c)));
...
HXLINE( 158)			::haxe::Log_obj::trace((HX_("loading ",24,de,81,cb) + this->actualNames->__get(this->curSelected)),::hx::SourceInfo(HX_("source/LoadReplayState.hx",6e,34,7a,fb),158,HX_("LoadReplayState",c4,3c,20,8a),HX_("update",09,86,05,87)));
