...
HXDLIN( 281)				return true;
            			...
            			break;
            			case (int)6: {
HXLINE( 285)				 ::Dynamic _g1 = _g->_hx_getObject(1);
HXDLIN( 285)				::String _g2 = _g->_hx_getString(0);
...
HXDLIN( 287)				return this->isBlock(e);
            			...
            			break;
            			case (int)11: {
HXLINE( 289)				 ::Dynamic _g1 = _g->_hx_getObject(1);
...
HXDLIN( 289)				return this->isBlock(e);
            			...
            			break;
            			case (int)14: {
HXLINE( 282)				 ::hscript::CType _g1 = _g->_hx_getObject(3).StaticCast<  ::hscript::CType >();
HXDLIN( 282)				::String _g2 = _g->_hx_getString(2);
HXDLIN( 282)				::Array< ::Dynamic> _g3 = _g->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE( 290)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 291)				 ::hscript::CType _g1 = _g->_hx_getObject(2).StaticCast<  ::hscript::CType >();
HXDLIN( 291)				::String _g2 = _g->_hx_getString(1);
HXDLIN( 291)				 ::Dynamic _g3 = _g->_hx_getObject(0);
...
HXDLIN( 281)				return true;
            			...
            			break;
            			case (int)23: {
HXLINE( 281)				 ::Dynamic _g1 = _g->_hx_getObject(2);
HXDLIN( 281)				::Array< ::Dynamic> _g2 = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 281)				 ::Dynamic _g3 = _g->_hx_getObject(0);
HXDLIN( 281)				return true;
            			}
            			break;
            			case (int)24: {
...
HXDLIN( 288)				return this->isBlock(e);
            			...
            			break;
            			case (int)25: {
HXLINE( 292)				::Array< ::Dynamic> _g1 = _g->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 292)				::String _g2 = _g->_hx_getString(0);
...
HXLINE( 303)					 ::Dynamic _g1 = _g->_hx_getObject(2);
HXDLIN( 303)					 ::hscript::CType _g2 = _g->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 303)					::String _g3 = _g->_hx_getString(0);
...
HXDLIN( 461)					switch((int)(_g->_hx_getIndex())){
            						case (int)10: {
HXLINE( 462)							 ::Dynamic _g1 = _g->_hx_getObject(1);
HXDLIN( 462)							 ::Dynamic _g2 = _g->_hx_getObject(0);
...
HXLINE( 469)							return this->parseExprNext(e8);
            						...
            						break;
            						case (int)11: {
HXLINE( 462)							 ::Dynamic _g1 = _g->_hx_getObject(2);
...
HXLINE( 527)					edef = ::hscript::ExprDef_obj::ECall(edef1,::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)9: {
HXLINE( 534)				 ::Dynamic e2 = _g->_hx_getObject(2);
HXDLIN( 534)				 ::Dynamic e1 = _g->_hx_getObject(1);
HXDLIN( 534)				 ::Dynamic cond = _g->_hx_getObject(0);
...
HXLINE( 527)					edef = ::hscript::ExprDef_obj::ECall(edef1,::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)10: {
HXLINE( 530)				 ::Dynamic e2 = _g->_hx_getObject(1);
HXDLIN( 530)				 ::Dynamic cond = _g->_hx_getObject(0);
HXLINE( 527)				edef = ::hscript::ExprDef_obj::EWhile(cond,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)11: {
HXLINE( 528)				 ::Dynamic e2 = _g->_hx_getObject(2);
HXDLIN( 528)				 ::Dynamic it = _g->_hx_getObject(1);
HXDLIN( 528)				::String v = _g->_hx_getString(0);
HXLINE( 527)				edef = ::hscript::ExprDef_obj::EFor(v,it,this->mapCompr(tmp,e2));
            			}
            			break;
            			case (int)24: {
HXLINE( 532)				 ::Dynamic e2 = _g->_hx_getObject(1);
HXDLIN( 532)				 ::Dynamic cond = _g->_hx_getObject(0);
...
HXDLIN( 549)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 550)				 ::Dynamic e2 = _g->_hx_getObject(2);
HXDLIN( 550)				 ::Dynamic e1 = _g->_hx_getObject(1);
HXDLIN( 550)				::String bop = _g->_hx_getString(0);
...
HXDLIN( 550)					return  ::Dynamic(::hx::Anon_obj::Create(5)
            			...
            			break;
            			case (int)22: {
HXLINE( 551)				 ::Dynamic e3 = _g->_hx_getObject(2);
HXDLIN( 551)				 ::Dynamic e2 = _g->_hx_getObject(1);
HXDLIN( 551)				 ::Dynamic e1 = _g->_hx_getObject(0);
...
HXDLIN( 559)		switch((int)(_g->_hx_getIndex())){
            			case (int)6: {
HXLINE( 560)				 ::Dynamic e3 = _g->_hx_getObject(2);
HXDLIN( 560)				 ::Dynamic e2 = _g->_hx_getObject(1);
HXDLIN( 560)				::String op2 = _g->_hx_getString(0);
...
HXDLIN( 564)						return  ::Dynamic(::hx::Anon_obj::Create(5)
            			...
            			break;
            			case (int)22: {
HXLINE( 565)				 ::Dynamic e4 = _g->_hx_getObject(2);
HXDLIN( 565)				 ::Dynamic e3 = _g->_hx_getObject(1);
HXDLIN( 565)				 ::Dynamic e2 = _g->_hx_getObject(0);
...
HXLINE( 778)									 ::hscript::CType t = _g->_hx_getObject(1).StaticCast<  ::hscript::CType >();
...
HXLINE(1582)				return this->evalPreproCond(e);
            			...
            			break;
            			case (int)6: {
HXLINE(1585)				 ::Dynamic _g1 = _g->_hx_getObject(2);
HXDLIN(1585)				 ::Dynamic _g2 = _g->_hx_getObject(1);
HXDLIN(1585)				::String _hx_switch_0 = _g->_hx_getString(0);
            				if (  (_hx_switch_0==HX_("&&",40,21,00,00)) ){
HXLINE(1583)					 ::Dynamic e2 = _g1;
HXDLIN(1583)					 ::Dynamic e1 = _g2;
...
HXLINE(1585)					 ::Dynamic e2 = _g1;
HXDLIN(1585)					 ::Dynamic e1 = _g2;
