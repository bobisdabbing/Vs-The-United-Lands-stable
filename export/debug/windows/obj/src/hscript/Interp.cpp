...
HXLINE( 139)							l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            				...
            				break;
            				case (int)5: {
HXLINE( 140)					::String f = _g->_hx_getString(1);
HXDLIN( 140)					 ::Dynamic e = _g->_hx_getObject(0);
HXLINE( 141)					v = this->set(this->expr(e),f,v);
            				}
            				break;
            				case (int)16: {
HXLINE( 142)					 ::Dynamic index = _g->_hx_getObject(1);
HXDLIN( 142)					 ::Dynamic e = _g->_hx_getObject(0);
HXDLIN( 142)					{
...
HXLINE( 172)							l->__SetField(HX_("r",72,00,00,00),v,::hx::paccDynamic);
            				...
            				break;
            				case (int)5: {
HXLINE( 173)					::String f = _g->_hx_getString(1);
HXDLIN( 173)					 ::Dynamic e = _g->_hx_getObject(0);
HXDLIN( 173)					{
...
HXLINE( 176)						v = this->set(obj,f,v);
            				...
            				break;
            				case (int)16: {
HXLINE( 177)					 ::Dynamic index = _g->_hx_getObject(1);
HXDLIN( 177)					 ::Dynamic e = _g->_hx_getObject(0);
HXDLIN( 177)					{
...
HXLINE( 208)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 209)				::String f = e1->_hx_getString(1);
HXDLIN( 209)				 ::Dynamic e = e1->_hx_getObject(0);
...
HXLINE( 217)				return v;
            			...
            			break;
            			case (int)16: {
HXLINE( 218)				 ::Dynamic index = e1->_hx_getObject(1);
HXDLIN( 218)				 ::Dynamic e = e1->_hx_getObject(0);
...
HXLINE( 344)				return v;
            			...
            			break;
            			case (int)5: {
HXLINE( 345)				::String f = e1->_hx_getString(1);
HXDLIN( 345)				 ::Dynamic e = e1->_hx_getObject(0);
HXLINE( 346)				return this->get(this->expr(e),f);
            			}
            			break;
            			case (int)6: {
HXLINE( 347)				 ::Dynamic e2 = e1->_hx_getObject(2);
HXDLIN( 347)				 ::Dynamic e11 = e1->_hx_getObject(1);
HXDLIN( 347)				::String op = e1->_hx_getString(0);
...
HXLINE( 350)				return fop(e11,e2);
            			...
            			break;
            			case (int)7: {
HXLINE( 351)				 ::Dynamic e = e1->_hx_getObject(2);
HXDLIN( 351)				bool prefix = e1->_hx_getBool(1);
HXDLIN( 351)				::String op = e1->_hx_getString(0);
...
HXDLIN( 368)					HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(e));
            			...
            			break;
            			case (int)8: {
HXLINE( 370)				::Array< ::Dynamic> params = e1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 370)				 ::Dynamic e = e1->_hx_getObject(0);
...
HXLINE( 376)					::String f = _g1->_hx_getString(1);
HXDLIN( 376)					 ::Dynamic e = _g1->_hx_getObject(0);
...
HXLINE( 381)					return this->call(null(),this->expr(e),args);
            			...
            			break;
            			case (int)9: {
HXLINE( 383)				 ::Dynamic e2 = e1->_hx_getObject(2);
HXDLIN( 383)				 ::Dynamic e11 = e1->_hx_getObject(1);
HXDLIN( 383)				 ::Dynamic econd = e1->_hx_getObject(0);
...
HXLINE( 384)						return this->expr(e2);
            			...
            			break;
            			case (int)10: {
HXLINE( 385)				 ::Dynamic e = e1->_hx_getObject(1);
HXDLIN( 385)				 ::Dynamic econd = e1->_hx_getObject(0);
HXLINE( 386)				this->whileLoop(econd,e);
HXLINE( 387)				return null();
            			}
            			break;
            			case (int)11: {
HXLINE( 391)				 ::Dynamic e = e1->_hx_getObject(2);
HXDLIN( 391)				 ::Dynamic it = e1->_hx_getObject(1);
HXDLIN( 391)				::String v = e1->_hx_getString(0);
...
HXLINE( 400)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown(::hscript::_Interp::Stop_obj::SReturn_dyn()));
            			...
            			break;
            			case (int)16: {
HXLINE( 512)				 ::Dynamic index = e1->_hx_getObject(1);
HXDLIN( 512)				 ::Dynamic e = e1->_hx_getObject(0);
...
HXLINE( 471)						 ::Dynamic _g1 = _g->_hx_getObject(2);
HXDLIN( 471)						 ::Dynamic _g2 = _g->_hx_getObject(1);
...
HXLINE( 480)										 ::Dynamic eValue = _g1->_hx_getObject(2);
HXDLIN( 480)										 ::Dynamic eKey = _g1->_hx_getObject(1);
HXDLIN( 480)										{
...
HXLINE( 510)					return a;
            			...
            			break;
            			case (int)18: {
HXLINE( 521)				::Array< ::Dynamic> params = e1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 521)				::String cl = e1->_hx_getString(0);
...
HXLINE( 555)				return o;
            			...
            			break;
            			case (int)22: {
HXLINE( 556)				 ::Dynamic e2 = e1->_hx_getObject(2);
HXDLIN( 556)				 ::Dynamic e11 = e1->_hx_getObject(1);
HXDLIN( 556)				 ::Dynamic econd = e1->_hx_getObject(0);
...
HXLINE( 557)					return this->expr(e2);
            			...
            			break;
            			case (int)23: {
HXLINE( 558)				 ::Dynamic def = e1->_hx_getObject(2);
HXDLIN( 558)				::Array< ::Dynamic> cases = e1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 558)				 ::Dynamic e = e1->_hx_getObject(0);
...
HXLINE( 574)				return val;
            			...
            			break;
            			case (int)24: {
HXLINE( 388)				 ::Dynamic e = e1->_hx_getObject(1);
...
HXLINE( 390)				return null();
            			...
            			break;
            			case (int)25: {
HXLINE( 575)				::Array< ::Dynamic> _g = e1->_hx_getObject(1).StaticCast< ::Array< ::Dynamic> >();
HXDLIN( 575)				::String _g1 = e1->_hx_getString(0);
