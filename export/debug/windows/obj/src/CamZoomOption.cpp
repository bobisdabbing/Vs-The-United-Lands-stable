...
HX_DEFINE_STACK_FRAME(_hx_pos_7858b555654f959a_1463_new,"CamZoomOption","new",0xae7b5429,"CamZoomOption.new","Options.hx",1463,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7858b555654f959a_1472_left,"CamZoomOption","left",0xfc1bd41e,"CamZoomOption.left","Options.hx",1472,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7858b555654f959a_1481_right,"CamZoomOption","right",0x134ad3e5,"CamZoomOption.right","Options.hx",1481,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_7858b555654f959a_1488_updateDisplay,"CamZoomOption","updateDisplay",0x0b240842,"CamZoomOption.updateDisplay","Options.hx",1488,0x9d9a0240)

void CamZoomOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_1463_new)
HXLINE(1464)		super::__construct();
HXLINE(1465)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1466)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE(1468)			this->description = desc;
            		}
            	}
...
bool CamZoomOption_obj::left(){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_1472_left)
HXLINE(1473)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1474)			return false;
            		}
HXLINE(1475)		::flixel::FlxG_obj::save->data->__SetField(HX_("camzoom",a2,ca,10,f1),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("camzoom",a2,ca,10,f1),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(1476)		this->display = this->updateDisplay();
HXLINE(1477)		return true;
            	}


bool CamZoomOption_obj::right(){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_1481_right)
HXLINE(1482)		this->left();
HXLINE(1483)		return true;
            	}


::String CamZoomOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_7858b555654f959a_1488_updateDisplay)
HXDLIN(1488)		::String _hx_tmp;
HXDLIN(1488)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("camzoom",a2,ca,10,f1),::hx::paccDynamic)) ))) {
HXDLIN(1488)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN(1488)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN(1488)		return ((HX_("Camera Zoom: < ",f8,25,b7,70) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
