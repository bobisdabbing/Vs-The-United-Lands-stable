...
HX_LOCAL_STACK_FRAME(_hx_pos_dfe8d92fa5dee8a4_266_average,"HitGraph","average",0x47c52e0a,"HitGraph.average","HitGraph.hx",266,0x9e69dd83)
HX_LOCAL_STACK_FRAME(_hx_pos_dfe8d92fa5dee8a4_274_destroy,"HitGraph","destroy",0x096fe9a7,"HitGraph.destroy","HitGraph.hx",274,0x9e69dd83)
...
Float HitGraph_obj::average(){
            	HX_STACKFRAME(&_hx_pos_dfe8d92fa5dee8a4_266_average)
HXLINE( 267)		Float sum = ( (Float)(0) );
HXLINE( 268)		{
HXLINE( 268)			int _g = 0;
HXDLIN( 268)			::cpp::VirtualArray _g1 = this->history;
HXDLIN( 268)			while((_g < _g1->get_length())){
HXLINE( 268)				 ::Dynamic value = _g1->__get(_g);
HXDLIN( 268)				_g = (_g + 1);
HXLINE( 269)				sum = (sum + value);
            			}
            		}
HXLINE( 270)		return (sum / ( (Float)(this->history->get_length()) ));
            	}
...
void HitGraph_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_dfe8d92fa5dee8a4_274_destroy)
HXLINE( 275)		this->_axis = ( ( ::openfl::display::Shape)(::flixel::util::FlxDestroyUtil_obj::removeChild(::hx::ObjectPtr<OBJ_>(this),this->_axis)) );
HXLINE( 276)		this->history = null();
            	}
