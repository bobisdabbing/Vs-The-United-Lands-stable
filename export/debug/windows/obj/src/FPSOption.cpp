...
HX_DEFINE_STACK_FRAME(_hx_pos_da44038d8b33767f_1053_new,"FPSOption","new",0xd6c03010,"FPSOption.new","Options.hx",1053,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_1059_left,"FPSOption","left",0x10176257,"FPSOption.left","Options.hx",1059,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_1067_right,"FPSOption","right",0x7b6bb78c,"FPSOption.right","Options.hx",1067,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_da44038d8b33767f_1074_updateDisplay,"FPSOption","updateDisplay",0x3edb6ae9,"FPSOption.updateDisplay","Options.hx",1074,0x9d9a0240)

void FPSOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_1053_new)
HXLINE(1054)		super::__construct();
HXLINE(1055)		this->description = desc;
            	}
...
bool FPSOption_obj::left(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_1059_left)
HXLINE(1060)		::flixel::FlxG_obj::save->data->__SetField(HX_("fps",e9,c7,4d,00),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(1061)		::hx::TCast<  ::Main >::cast(::openfl::Lib_obj::get_current()->getChildAt(0))->toggleFPS(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ));
...
bool FPSOption_obj::right(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_1067_right)
...
::String FPSOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_da44038d8b33767f_1074_updateDisplay)
HXDLIN(1074)		::String _hx_tmp;
HXDLIN(1074)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("fps",e9,c7,4d,00),::hx::paccDynamic)) ))) {
HXDLIN(1074)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN(1074)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN(1074)		return ((HX_("FPS Counter: < ",8f,72,b2,82) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
