...
HXLINE( 139)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,((HX_("Couldn't load gf: ",39,89,f4,2a) + ::GameplayCustomizeState_obj::freeplayGf) + HX_(". Loading default gf",14,ac,22,78))),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
HXLINE( 149)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,((HX_("Couldn't load boyfriend: ",5c,12,d6,52) + ::GameplayCustomizeState_obj::freeplayBf) + HX_(". Loading default boyfriend",15,30,39,4a))),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
HXLINE( 159)			::flixel::FlxG_obj::log->advanced(::cpp::VirtualArray_obj::__new(1)->init(0,((HX_("Couldn't load opponent: ",37,43,16,aa) + ::GameplayCustomizeState_obj::freeplayDad) + HX_(". Loading default opponent",52,71,f8,4c))),::flixel::_hx_system::debug::log::LogStyle_obj::WARNING,true);
...
HXLINE( 305)		this->laneunderlay->screenCenter(::flixel::util::FlxAxes_obj::Y_dyn());
HXLINE( 306)		this->laneunderlayOpponent->screenCenter(::flixel::util::FlxAxes_obj::Y_dyn());
...
HXLINE( 314)		 ::flixel::FlxSprite _hx_tmp7 =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-30,(::flixel::FlxG_obj::height + 40),null());
HXDLIN( 314)		int _hx_tmp8 = ::Std_obj::_hx_int((this->text->get_width() + 900));
HXDLIN( 314)		this->blackBorder = _hx_tmp7->makeGraphic(_hx_tmp8,::Std_obj::_hx_int((this->text->get_height() + 600)),-16777216,null(),null());
...
HXDLIN( 367)		if (_this->keyManager->checkStatus(81,_this->status)) {
...
HXDLIN( 373)		if (_this1->keyManager->checkStatus(69,_this1->status)) {
...
HXDLIN( 386)		if (_this2->keyManager->checkStatus(67,_this2->status)) {
...
HXLINE( 413)					numScore3->screenCenter(null());
...
HXDLIN( 465)		if (_this3->keyManager->checkStatus(82,_this3->status)) {
...
HXDLIN( 498)		if (!(_this->keyManager->checkStatus(32,_this->status))) {
HXLINE( 500)			{
...
HXLINE( 504)		::haxe::Log_obj::trace(HX_("beat",76,e1,13,41),::hx::SourceInfo(HX_("source/GameplayCustomizeState.hx",56,1d,99,c3),504,HX_("GameplayCustomizeState",74,30,cf,3c),HX_("beatHit",7d,ea,04,74)));
            	}
