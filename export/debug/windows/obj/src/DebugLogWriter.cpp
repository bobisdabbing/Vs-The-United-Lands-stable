...
HX_DEFINE_STACK_FRAME(_hx_pos_161373f69ee8fd30_347_new,"DebugLogWriter","new",0x033bdc96,"DebugLogWriter.new","Debug.hx",347,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_396_isActive,"DebugLogWriter","isActive",0xc261cd5a,"DebugLogWriter.isActive","Debug.hx",396,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_407_getTime,"DebugLogWriter","getTime",0x9d00daf9,"DebugLogWriter.getTime","Debug.hx",407,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_415_shouldLog,"DebugLogWriter","shouldLog",0x281a5ec7,"DebugLogWriter.shouldLog","Debug.hx",415,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_424_setLogLevel,"DebugLogWriter","setLogLevel",0x888a4e58,"DebugLogWriter.setLogLevel","Debug.hx",424,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_438_write,"DebugLogWriter","write",0x66857295,"DebugLogWriter.write","Debug.hx",438,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_464_printDebug,"DebugLogWriter","printDebug",0x47c72d70,"DebugLogWriter.printDebug","Debug.hx",464,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_349_boot,"DebugLogWriter","boot",0xc93e273c,"DebugLogWriter.boot","Debug.hx",349,0x6a71a26b)
HX_LOCAL_STACK_FRAME(_hx_pos_161373f69ee8fd30_350_boot,"DebugLogWriter","boot",0xc93e273c,"DebugLogWriter.boot","Debug.hx",350,0x6a71a26b)
...
void DebugLogWriter_obj::__construct(::String logLevelParam){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_347_new)
HXLINE( 359)		this->active = false;
HXLINE( 355)		this->startTime = ((Float)0);
HXLINE( 366)		this->logLevel = ::DebugLogWriter_obj::LOG_LEVELS->indexOf(logLevelParam,null());
HXLINE( 369)		this->printDebug(HX_("Initializing log file...",63,91,1e,d4));
HXLINE( 371)		::String logFilePath = ((((HX_("",00,00,00,00) + ::DebugLogWriter_obj::LOG_FOLDER) + HX_("/",2f,00,00,00)) + ::Sys_obj::time()) + HX_(".log",16,25,ba,1e));
HXLINE( 374)		if ((logFilePath.indexOf(HX_("/",2f,00,00,00),null()) != -1)) {
HXLINE( 376)			int lastIndex = logFilePath.lastIndexOf(HX_("/",2f,00,00,00),null());
HXLINE( 377)			::String logFolderPath = logFilePath.substr(0,lastIndex);
HXLINE( 378)			this->printDebug((HX_("Creating log folder ",cf,36,41,60) + logFolderPath));
HXLINE( 379)			::sys::FileSystem_obj::createDirectory(logFolderPath);
            		}
HXLINE( 382)		this->printDebug((HX_("Creating log file ",01,42,7c,71) + logFilePath));
HXLINE( 383)		this->file = ::sys::io::File_obj::write(logFilePath,false);
HXLINE( 384)		this->active = true;
HXLINE( 391)		this->startTime = ::Sys_obj::time();
            	}
...
bool DebugLogWriter_obj::isActive(){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_396_isActive)
HXDLIN( 396)		return this->active;
            	}
...
Float DebugLogWriter_obj::getTime(::hx::Null< bool >  __o_abs){
            	...
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_407_getTime)
HXDLIN( 407)		if (abs) {
HXDLIN( 407)			return ::Sys_obj::time();
            		}
            		else {
HXDLIN( 407)			Float _hx_tmp = ::Sys_obj::time();
HXDLIN( 407)			return (_hx_tmp - this->startTime);
            		}
HXDLIN( 407)		return ((Float)0.);
            	}
...
bool DebugLogWriter_obj::shouldLog(::String input){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_415_shouldLog)
HXLINE( 416)		int levelIndex = ::DebugLogWriter_obj::LOG_LEVELS->indexOf(input,null());
HXLINE( 418)		if ((levelIndex == -1)) {
HXLINE( 419)			return false;
            		}
HXLINE( 420)		return (levelIndex <= this->logLevel);
            	}
...
void DebugLogWriter_obj::setLogLevel(::String input){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_424_setLogLevel)
HXLINE( 425)		int levelIndex = ::DebugLogWriter_obj::LOG_LEVELS->indexOf(input,null());
HXLINE( 427)		if ((levelIndex == -1)) {
HXLINE( 428)			return;
            		}
HXLINE( 430)		this->logLevel = levelIndex;
HXLINE( 431)		::flixel::FlxG_obj::save->data->__SetField(HX_("debugLogLevel",d3,6b,21,7d),this->logLevel,::hx::paccDynamic);
            	}
...
void DebugLogWriter_obj::write(::cpp::VirtualArray input,::String __o_logLevel){
            	...
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_438_write)
HXLINE( 439)		Float ts;
HXDLIN( 439)		{
HXLINE( 439)			Float ts1 = ::Sys_obj::time();
HXDLIN( 439)			ts = (ts1 - this->startTime);
            		}
HXDLIN( 439)		::String ts2 = ::flixel::util::FlxStringUtil_obj::formatTime(ts,true);
HXLINE( 440)		::String msg = ((((HX_("",00,00,00,00) + ts2) + HX_(" [",3b,1c,00,00)) + ::StringTools_obj::rpad(logLevel,HX_(" ",20,00,00,00),5)) + HX_("] ",23,51,00,00));
HXDLIN( 440)		::String msg1 = (msg + input->join(HX_("",00,00,00,00)));
HXLINE( 443)		bool _hx_tmp;
HXDLIN( 443)		if (this->active) {
HXLINE( 443)			_hx_tmp = ::hx::IsNotNull( this->file );
            		}
            		else {
...
HXLINE( 447)				this->file->writeString(((HX_("",00,00,00,00) + msg1) + HX_("\n",0a,00,00,00)),null());
HXLINE( 448)				this->file->flush();
HXLINE( 449)				this->file->flush();
            			}
            		}
HXLINE( 455)		if (this->shouldLog(logLevel)) {
HXLINE( 457)			this->printDebug(msg1);
            		}
            	}
...
void DebugLogWriter_obj::printDebug(::String msg){
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_464_printDebug)
HXDLIN( 464)		::Sys_obj::println(msg);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_349_boot)
HXDLIN( 349)		LOG_FOLDER = HX_("logs",6f,9f,b7,47);
            	}
{
            	HX_STACKFRAME(&_hx_pos_161373f69ee8fd30_350_boot)
HXDLIN( 350)		LOG_LEVELS = ::Array_obj< ::String >::fromData( _hx_array_data_840899a4_9,4);
            	}
}
