...
HX_DEFINE_STACK_FRAME(_hx_pos_3ef98e6da45dca70_1725_new,"ResetScoreOption","new",0x5d8eefea,"ResetScoreOption.new","Options.hx",1725,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3ef98e6da45dca70_1739_press,"ResetScoreOption","press",0x4271e98d,"ResetScoreOption.press","Options.hx",1739,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_3ef98e6da45dca70_1766_updateDisplay,"ResetScoreOption","updateDisplay",0x42963f43,"ResetScoreOption.updateDisplay","Options.hx",1766,0x9d9a0240)

void ResetScoreOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_1725_new)
HXLINE(1727)		this->confirm = false;
HXLINE(1731)		super::__construct();
HXLINE(1732)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1733)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE(1735)			this->description = desc;
            		}
            	}
...
bool ResetScoreOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_1739_press)
HXLINE(1740)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1741)			return false;
            		}
HXLINE(1742)		if (!(this->confirm)) {
HXLINE(1744)			this->confirm = true;
HXLINE(1745)			this->display = this->updateDisplay();
HXLINE(1746)			return true;
            		}
HXLINE(1748)		::flixel::FlxG_obj::save->data->__SetField(HX_("songScores",96,1a,f0,a0),null(),::hx::paccDynamic);
HXLINE(1749)		{
HXLINE(1749)			 ::Dynamic key = ::Highscore_obj::songScores->keys();
HXDLIN(1749)			while(( (bool)(key->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1749)				::String key1 = ( (::String)(key->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1751)				::Highscore_obj::songScores->set(key1,0);
            			}
            		}
HXLINE(1753)		::flixel::FlxG_obj::save->data->__SetField(HX_("songCombos",1a,c2,aa,22),null(),::hx::paccDynamic);
HXLINE(1754)		{
HXLINE(1754)			 ::Dynamic key1 = ::Highscore_obj::songCombos->keys();
HXDLIN(1754)			while(( (bool)(key1->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE(1754)				::String key = ( (::String)(key1->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE(1756)				::Highscore_obj::songCombos->set(key,HX_("",00,00,00,00));
            			}
            		}
HXLINE(1758)		this->confirm = false;
HXLINE(1759)		::haxe::Log_obj::trace(HX_("Highscores Wiped",e0,31,8c,e1),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),1759,HX_("ResetScoreOption",f8,72,52,34),HX_("press",83,53,88,c8)));
HXLINE(1760)		this->display = this->updateDisplay();
HXLINE(1761)		return true;
            	}


::String ResetScoreOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_3ef98e6da45dca70_1766_updateDisplay)
HXDLIN(1766)		if (this->confirm) {
HXDLIN(1766)			return HX_("Confirm Score Reset",01,e3,61,66);
            		}
            		else {
HXDLIN(1766)			return HX_("Reset Score",01,16,25,27);
            		}
HXDLIN(1766)		return null();
            	}
