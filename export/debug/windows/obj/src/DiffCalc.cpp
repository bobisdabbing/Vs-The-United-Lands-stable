...
HXLINE(  49)		::haxe::Log_obj::trace((HX_("calcuilafjwaf ",26,26,86,b3) + cleanedNotes->length),::hx::SourceInfo(HX_("source/DiffCalc.hx",30,41,49,57),49,HX_("DiffCalc",5a,43,8d,ef),HX_("CalculateDiff",6b,18,eb,e6)));
