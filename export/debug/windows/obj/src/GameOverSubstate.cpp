...
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_130_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",130,0x01fbc1e7)
HX_LOCAL_STACK_FRAME(_hx_pos_b2ae8d30512793fc_129_endBullshit,"GameOverSubstate","endBullshit",0xd9747d97,"GameOverSubstate.endBullshit","GameOverSubstate.hx",129,0x01fbc1e7)

void GameOverSubstate_obj::__construct(Float x,Float y){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_10_new)
HXLINE( 116)		this->isEnding = false;
...
HXLINE(  73)				::GameplayCustomizeState_obj::freeplayBf = HX_("bf",c4,55,00,00);
HXLINE(  74)				::GameplayCustomizeState_obj::freeplayDad = HX_("dad",47,36,4c,00);
HXLINE(  75)				::GameplayCustomizeState_obj::freeplayGf = HX_("gf",1f,5a,00,00);
HXLINE(  76)				::GameplayCustomizeState_obj::freeplayNoteStyle = HX_("normal",27,72,69,30);
HXLINE(  77)				::GameplayCustomizeState_obj::freeplayStage = HX_("stage",be,6a,0b,84);
HXLINE(  78)				::GameplayCustomizeState_obj::freeplaySong = HX_("bopeebo",b0,01,c5,0c);
HXLINE(  79)				::GameplayCustomizeState_obj::freeplayWeek = 1;
HXLINE(  80)				{
HXLINE(  80)					 ::flixel::FlxState nextState =  ::StoryMenuState_obj::__alloc( HX_CTX ,null(),null());
...
HXLINE(  83)				 ::flixel::FlxState nextState =  ::FreeplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(  83)				if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(  83)					::flixel::FlxG_obj::game->_requestedState = nextState;
            				}
            			}
HXLINE(  84)			::PlayState_obj::loadRep = false;
HXLINE(  85)			::PlayState_obj::stageTesting = false;
            		}
HXLINE(  88)		bool _hx_tmp;
HXDLIN(  88)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  88)			_hx_tmp = (this->bf->animation->_curAnim->curFrame == 12);
            		}
            		else {
HXLINE(  88)			_hx_tmp = false;
            		}
HXDLIN(  88)		if (_hx_tmp) {
HXLINE(  90)			::flixel::FlxG_obj::camera->follow(this->camFollow,::flixel::FlxCameraFollowStyle_obj::LOCKON_dyn(),((Float)0.01));
            		}
HXLINE(  93)		bool _hx_tmp1;
HXDLIN(  93)		if ((this->bf->animation->_curAnim->name == HX_("firstDeath",e4,d8,fc,14))) {
HXLINE(  93)			_hx_tmp1 = this->bf->animation->_curAnim->finished;
            		}
            		else {
...
HXLINE(  96)			this->startVibin = true;
            		}
HXLINE(  99)		if (::hx::IsNotNull( ::flixel::FlxG_obj::sound->music->_channel )) {
HXLINE( 101)			::Conductor_obj::songPosition = ::flixel::FlxG_obj::sound->music->_time;
            		}
            	}
...
HXLINE( 107)		this->super::beatHit();
HXLINE( 109)		bool _hx_tmp;
HXDLIN( 109)		if (this->startVibin) {
HXLINE( 109)			_hx_tmp = !(this->isEnding);
            		}
            		else {
HXLINE( 109)			_hx_tmp = false;
            		}
HXDLIN( 109)		if (_hx_tmp) {
HXLINE( 111)			this->bf->playAnim(HX_("deathLoop",b8,0b,79,2e),true,null(),null());
            		}
HXLINE( 113)		::flixel::FlxG_obj::log->advanced(HX_("beat",76,e1,13,41),::flixel::_hx_system::debug::log::LogStyle_obj::NORMAL,null());
            	}


void GameOverSubstate_obj::endBullshit(){
            	HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_120_endBullshit)
HXDLIN( 120)		if (!(this->isEnding)) {
            			HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            				void _hx_run(){
            					HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_130_endBullshit)
HXLINE( 131)					{
HXLINE( 131)						 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(( ( ::flixel::FlxState)( ::PlayState_obj::__alloc( HX_CTX ,null(),null())) ),false);
HXDLIN( 131)						if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE( 131)							::flixel::FlxG_obj::game->_requestedState = nextState;
            						}
            					}
HXLINE( 132)					::PlayState_obj::stageTesting = false;
            				}
            				HX_END_LOCAL_FUNC0((void))

            				HX_GC_STACKFRAME(&_hx_pos_b2ae8d30512793fc_129_endBullshit)
HXLINE( 129)				::flixel::FlxG_obj::camera->fade(-16777216,2,false, ::Dynamic(new _hx_Closure_0()),null());
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 122)			::PlayState_obj::startTime = ( (Float)(0) );
HXLINE( 123)			this->isEnding = true;
HXLINE( 124)			this->bf->playAnim(HX_("deathConfirm",2c,44,2b,12),true,null(),null());
HXLINE( 125)			{
...
HXDLIN( 126)			::String library = null();
HXDLIN( 126)			_hx_tmp->play(::Paths_obj::getPath((((HX_("music/",ea,bf,1b,3f) + (HX_("gameOverEnd",15,2d,a9,8d) + this->stageSuffix)) + HX_(".",2e,00,00,00)) + HX_("ogg",4f,94,54,00)),HX_("MUSIC",85,08,49,8e),library),null(),null(),null(),null(),null());
HXLINE( 127)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(((Float)0.7), ::Dynamic(new _hx_Closure_1()),null());
            		}
            	}
