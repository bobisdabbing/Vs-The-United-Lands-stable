...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_69_create,"LoadingState","create",0x65cff835,"LoadingState.create","LoadingState.hx",69,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_92_checkLibrary,"LoadingState","checkLibrary",0xd141a10c,"LoadingState.checkLibrary","LoadingState.hx",92,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_109_beatHit,"LoadingState","beatHit",0x12c36b24,"LoadingState.beatHit","LoadingState.hx",109,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_183_destroy,"LoadingState","destroy",0xc344ada1,"LoadingState.destroy","LoadingState.hx",183,0x53ff9bc9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_251_initSongsManifest,"LoadingState","initSongsManifest",0xe6a6ff04,"LoadingState.initSongsManifest","LoadingState.hx",251,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_7b9d652bf7289928_190_initSongsManifest,"LoadingState","initSongsManifest",0xe6a6ff04,"LoadingState.initSongsManifest","LoadingState.hx",190,0x53ff9bc9)
...
void LoadingState_obj::create(){
            		...
            		void _hx_run( ::lime::utils::AssetLibrary lib){
            			...
            			void _hx_run( ::flixel::util::FlxTimer _){
            				HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_69_create)
HXLINE(  69)				introComplete();
            			}
...
HXLINE(  62)			if ((::PlayState_obj::storyWeek > 0)) {
HXLINE(  63)				_gthis->checkLibrary((HX_("week",f4,5f,f5,4e) + ::PlayState_obj::storyWeek));
            			}
            			else {
HXLINE(  65)				_gthis->checkLibrary(HX_("tutorial",9e,8f,b5,82));
            			}
HXLINE(  67)			Float fadeTime = ((Float)0.5);
HXLINE(  68)			::flixel::FlxG_obj::camera->fade(::flixel::FlxG_obj::camera->bgColor,fadeTime,true,null(),null());
HXLINE(  69)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start((fadeTime + ((Float)1.0)), ::Dynamic(new _hx_Closure_0(introComplete)),null());
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_36_create)
HXLINE(  35)		 ::LoadingState _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE(  37)		this->logo =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-150,-100,null());
HXLINE(  38)		 ::flixel::FlxSprite _hx_tmp = this->logo;
HXDLIN(  38)		_hx_tmp->set_frames(::Paths_obj::getSparrowAtlas(HX_("logoBumpin",26,cb,02,ab),null(),null()));
HXLINE(  39)		this->logo->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
...
HXLINE(  47)		 ::flixel::FlxSprite _hx_tmp1 = this->gfDance;
HXDLIN(  47)		_hx_tmp1->set_frames(::Paths_obj::getSparrowAtlas(HX_("gfDanceTitle",64,64,d2,7b),null(),null()));
...
HXLINE(  50)		this->gfDance->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
...
void LoadingState_obj::checkLibrary(::String library){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_92_checkLibrary)
HXLINE(  93)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN(  93)		bool _hx_tmp1 = ::openfl::utils::Assets_obj::hasLibrary(library);
HXDLIN(  93)		_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),93,HX_("LoadingState",15,62,ae,41),HX_("checkLibrary",13,df,f6,2c)));
HXLINE(  94)		if (::hx::IsNull( ::openfl::utils::Assets_obj::getLibrary(library) )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,callback) HXARGC(1)
...
HXLINE(  97)			if (!(::lime::utils::Assets_obj::libraryPaths->exists(library))) {
HXLINE(  98)				HX_STACK_DO_THROW(::haxe::Exception_obj::thrown((HX_("Missing library: ",07,45,01,4f) + library)));
            			}
HXLINE( 100)			 ::Dynamic callback = this->callbacks->add((HX_("library:",df,f4,b1,42) + library));
HXLINE( 101)			::openfl::utils::Assets_obj::loadLibrary(library)->onComplete( ::Dynamic(new _hx_Closure_0(callback)));
            		}
            	}
...
void LoadingState_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_109_beatHit)
HXLINE( 110)		this->super::beatHit();
HXLINE( 112)		this->logo->animation->play(HX_("bump",f6,0f,20,41),null(),null(),null());
HXLINE( 113)		this->danceLeft = !(this->danceLeft);
HXLINE( 115)		if (this->danceLeft) {
HXLINE( 116)			this->gfDance->animation->play(HX_("danceRight",a9,7f,a6,91),null(),null(),null());
            		}
            		else {
HXLINE( 118)			this->gfDance->animation->play(HX_("danceLeft",da,cc,f9,df),null(),null(),null());
            		}
            	}
...
HXDLIN( 125)		if (_this->keyManager->checkStatus(32,_this->status)) {
HXLINE( 126)			 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 126)			::String _hx_tmp1 = ((HX_("fired: ",14,f6,c2,73) + ::Std_obj::string(this->callbacks->getFired())) + HX_(" unfired:",c5,53,95,e9));
HXDLIN( 126)			::String _hx_tmp2 = (_hx_tmp1 + ::Std_obj::string(this->callbacks->getUnfired()));
HXDLIN( 126)			_hx_tmp(_hx_tmp2,::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),126,HX_("LoadingState",15,62,ae,41),HX_("update",09,86,05,87)));
            		}
            	}
...
HXLINE( 135)		{
HXLINE( 135)			 ::flixel::FlxState nextState = this->target;
...
void LoadingState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_7b9d652bf7289928_183_destroy)
HXLINE( 184)		this->super::destroy();
HXLINE( 186)		this->callbacks = null();
            	}
...
HXDLIN( 140)		::String songLowercase = ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("songId",10,c3,88,2d),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
HXDLIN( 140)		::String _hx_switch_0 = songLowercase;
            		if (  (_hx_switch_0==HX_("dad-battle",be,d5,66,07)) ){
HXDLIN( 140)			songLowercase = HX_("dadbattle",bf,6a,a9,a6);
HXDLIN( 140)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("m.i.l.f",9e,fe,da,ac)) ){
HXDLIN( 140)			songLowercase = HX_("milf",d6,4c,5c,48);
HXDLIN( 140)			goto _hx_goto_14;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
HXDLIN( 140)			songLowercase = HX_("philly",28,77,5e,ef);
HXDLIN( 140)			goto _hx_goto_14;
            		}
            		_hx_goto_14:;
HXDLIN( 140)		return (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Inst.",f9,6e,13,1c)) + HX_("ogg",4f,94,54,00));
            	}
...
HXDLIN( 145)		::String songLowercase = ::StringTools_obj::replace(( (::String)(::PlayState_obj::SONG->__Field(HX_("songId",10,c3,88,2d),::hx::paccDynamic)) ),HX_(" ",20,00,00,00),HX_("-",2d,00,00,00)).toLowerCase();
...
HXDLIN( 145)			goto _hx_goto_16;
            		...
            		if (  (_hx_switch_0==HX_("m.i.l.f",9e,fe,da,ac)) ){
HXDLIN( 145)			songLowercase = HX_("milf",d6,4c,5c,48);
HXDLIN( 145)			goto _hx_goto_16;
            		}
            		if (  (_hx_switch_0==HX_("philly-nice",22,2e,26,44)) ){
...
HXDLIN( 145)			goto _hx_goto_16;
            		...
            		_hx_goto_16:;
HXDLIN( 145)		::String result = (((HX_("songs:assets/songs/",c1,ed,e6,7e) + songLowercase) + HX_("/Voices.",1e,f6,e5,90)) + HX_("ogg",4f,94,54,00));
HXDLIN( 145)		if (::Paths_obj::doesSoundAssetExist(result)) {
HXDLIN( 145)			return result;
            		}
            		else {
...
HXDLIN( 150)		 ::flixel::FlxState nextState = ::LoadingState_obj::getNextState(target,stopMusic);
HXDLIN( 150)		if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXDLIN( 150)			::flixel::FlxG_obj::game->_requestedState = nextState;
            		}
            	}
...
HXLINE( 155)		::Paths_obj::setCurrentLevel((HX_("week",f4,5f,f5,4e) + ::PlayState_obj::storyWeek));
HXLINE( 164)		bool _hx_tmp;
HXDLIN( 164)		if (stopMusic) {
HXLINE( 164)			_hx_tmp = ::hx::IsNotNull( ::flixel::FlxG_obj::sound->music );
            		}
            		else {
HXLINE( 164)			_hx_tmp = false;
            		}
HXDLIN( 164)		if (_hx_tmp) {
HXLINE( 165)			 ::flixel::_hx_system::FlxSound _this = ::flixel::FlxG_obj::sound->music;
HXDLIN( 165)			_this->cleanup(_this->autoDestroy,true);
            		}
HXLINE( 167)		return target;
            	}
...
HXLINE( 230)			if (::hx::IsNull( manifest )) {
HXLINE( 232)				promise->error(((HX_("Cannot parse asset manifest for library \"",cf,1e,cc,48) + id) + HX_("\"",22,00,00,00)));
HXLINE( 233)				return;
            			}
HXLINE( 236)			 ::lime::utils::AssetLibrary library = ::lime::utils::AssetLibrary_obj::fromManifest(manifest);
HXLINE( 238)			if (::hx::IsNull( library )) {
HXLINE( 240)				promise->error(((HX_("Cannot open library \"",44,cc,55,e7) + id) + HX_("\"",22,00,00,00)));
            			}
            			else {
HXLINE( 245)				::lime::utils::Assets_obj::libraries->set(id,library);
HXLINE( 246)				library->onChange->add(::lime::utils::Assets_obj::onChange->dispatch_dyn(),null(),null());
HXLINE( 247)				 ::lime::app::Promise_lime_utils_AssetLibrary promise1 = promise;
HXDLIN( 247)				promise1->completeWith(::lime::app::Future_obj::withValue(library));
            			}
            		}
            		HX_END_LOCAL_FUNC1((void))
            		...
            		void _hx_run( ::Dynamic _){
            			HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_251_initSongsManifest)
HXLINE( 251)			promise->error(((HX_("There is no asset library with an ID of \"",8b,06,e2,9a) + id) + HX_("\"",22,00,00,00)));
            		}
            		HX_END_LOCAL_FUNC1((void))

            	HX_GC_STACKFRAME(&_hx_pos_7b9d652bf7289928_190_initSongsManifest)
HXLINE( 193)		::String id = HX_("songs",fe,36,c7,80);
HXLINE( 194)		 ::lime::app::Promise_lime_utils_AssetLibrary promise =  ::lime::app::Promise_lime_utils_AssetLibrary_obj::__alloc( HX_CTX );
HXLINE( 196)		 ::lime::utils::AssetLibrary library = ::openfl::utils::Assets_obj::getLibrary(id);
HXLINE( 198)		if (::hx::IsNotNull( library )) {
HXLINE( 200)			return ::lime::app::Future_obj::withValue(library);
            		}
HXLINE( 203)		::String path = id;
HXLINE( 204)		::String rootPath = null();
HXLINE( 207)		 ::haxe::ds::StringMap libraryPaths = ::lime::utils::Assets_obj::libraryPaths;
HXLINE( 208)		if (libraryPaths->exists(id)) {
HXLINE( 210)			path = libraryPaths->get_string(id);
HXLINE( 211)			rootPath = ::haxe::io::Path_obj::directory(path);
            		}
            		else {
HXLINE( 215)			if (::StringTools_obj::endsWith(path,HX_(".bundle",30,4a,b8,4e))) {
HXLINE( 217)				rootPath = path;
HXLINE( 218)				path = (path + HX_("/library.json",2a,a7,07,47));
            			}
            			else {
HXLINE( 222)				rootPath = ::haxe::io::Path_obj::directory(path);
            			}
HXLINE( 225)			path = ::lime::utils::Assets_obj::_hx___cacheBreak(path);
            		}
HXLINE( 228)		::lime::utils::AssetManifest_obj::loadFromFile(path,rootPath)->onComplete( ::Dynamic(new _hx_Closure_0(id,promise)))->onError( ::Dynamic(new _hx_Closure_1(id,promise)));
