...
HX_DEFINE_STACK_FRAME(_hx_pos_1637001de69262c2_1257_new,"ReplayOption","new",0x7094b10e,"ReplayOption.new","Options.hx",1257,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_1263_press,"ReplayOption","press",0x73453bb1,"ReplayOption.press","Options.hx",1263,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_1637001de69262c2_1271_updateDisplay,"ReplayOption","updateDisplay",0xfbfe5567,"ReplayOption.updateDisplay","Options.hx",1271,0x9d9a0240)

void ReplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_1257_new)
HXLINE(1258)		super::__construct();
HXLINE(1259)		this->description = desc;
            	}
...
bool ReplayOption_obj::press(){
            	HX_GC_STACKFRAME(&_hx_pos_1637001de69262c2_1263_press)
HXLINE(1264)		::haxe::Log_obj::trace(HX_("switch",f4,49,79,c5),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),1264,HX_("ReplayOption",1c,d2,4f,b9),HX_("press",83,53,88,c8)));
HXLINE(1265)		{
HXLINE(1265)			 ::flixel::FlxState nextState =  ::LoadReplayState_obj::__alloc( HX_CTX ,null(),null());
HXDLIN(1265)			if (::flixel::FlxG_obj::game->_state->switchTo(nextState)) {
HXLINE(1265)				::flixel::FlxG_obj::game->_requestedState = nextState;
            			}
            		}
...
::String ReplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_1637001de69262c2_1271_updateDisplay)
HXDLIN(1271)		return HX_("Load replays",92,1b,40,79);
            	}
