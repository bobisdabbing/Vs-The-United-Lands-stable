...
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_307_log,"MultiCallback","log",0x36816d54,"MultiCallback.log","LoadingState.hx",307,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_312_getFired,"MultiCallback","getFired",0x1ac970a8,"MultiCallback.getFired","LoadingState.hx",312,0x53ff9bc9)
HX_LOCAL_STACK_FRAME(_hx_pos_6e3535bb8cfd14a6_315_getUnfired,"MultiCallback","getUnfired",0xfdf08a2f,"MultiCallback.getUnfired","LoadingState.hx",315,0x53ff9bc9)
...
HXLINE( 288)				if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 289)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 289)						::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + ((((HX_("fired ",72,04,21,89) + id) + HX_(", ",74,26,00,00)) + _gthis->numRemaining) + HX_(" remaining",d6,c2,10,c5))),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),308,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            					}
            				}
HXLINE( 291)				if ((_gthis->numRemaining == 0)) {
HXLINE( 293)					if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 294)						if (::hx::IsNotNull( _gthis->logId )) {
HXLINE( 294)							::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + HX_("all callbacks fired",5d,d8,ec,82)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),308,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            						}
            					}
...
HXLINE( 299)					::haxe::Log_obj::trace((((HX_("",00,00,00,00) + _gthis->logId) + HX_(": ",a6,32,00,00)) + (HX_("already fired ",fa,e7,0c,57) + id)),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),308,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            				}
            			}
            		}
...
void MultiCallback_obj::log(::String msg){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_307_log)
HXDLIN( 307)		if (::hx::IsNotNull( this->logId )) {
HXLINE( 308)			::haxe::Log_obj::trace((((HX_("",00,00,00,00) + this->logId) + HX_(": ",a6,32,00,00)) + msg),::hx::SourceInfo(HX_("source/LoadingState.hx",55,7f,fd,f0),308,HX_("MultiCallback",3e,d1,b2,64),HX_("log",84,54,52,00)));
            		}
            	}
...
::Array< ::String > MultiCallback_obj::getFired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_312_getFired)
HXDLIN( 312)		return this->fired->copy();
            	}
...
::Array< ::String > MultiCallback_obj::getUnfired(){
            	HX_STACKFRAME(&_hx_pos_6e3535bb8cfd14a6_315_getUnfired)
HXDLIN( 315)		::Array< ::String > _g = ::Array_obj< ::String >::__new(0);
HXDLIN( 315)		{
HXDLIN( 315)			 ::Dynamic id = this->unfired->keys();
HXDLIN( 315)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXDLIN( 315)				::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXDLIN( 315)				_g->push(id1);
            			}
            		}
HXDLIN( 315)		return _g;
            	}
