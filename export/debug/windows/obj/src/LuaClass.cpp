...
HX_LOCAL_STACK_FRAME(_hx_pos_4fd24ca0ebdf46db_150_SetProperty,"LuaClass","SetProperty",0xc8b7ac09,"LuaClass.SetProperty","LuaClass.hx",150,0xe0a4e33e)
...
HXLINE( 101)					ret = ::llua::Convert_obj::toHaxeObj(l1,-1);
            				...
            				default:{
HXLINE( 101)					ret = null();
HXDLIN( 101)					 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 101)					::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(-1)));
HXDLIN( 101)					_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            				}
            			}
...
HXLINE( 129)					ret = ::llua::Convert_obj::toHaxeObj(l1,-1);
            				...
            				default:{
HXLINE( 129)					ret = null();
HXDLIN( 129)					 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 129)					::String _hx_tmp1 = (HX_("return value not supported\n",48,41,fb,c8) + ::Std_obj::string(::Type_obj::_hx_typeof(-1)));
HXDLIN( 129)					_hx_tmp(_hx_tmp1,::hx::SourceInfo(HX_("llua/Convert.hx",6e,6a,e3,49),103,HX_("llua.Convert",31,b8,44,19),HX_("fromLua",6e,2a,fd,57)));
            				}
            			}
...
void LuaClass_obj::SetProperty( cpp::Reference<lua_State> l,int tableIndex,::String key, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_4fd24ca0ebdf46db_150_SetProperty)
HXLINE( 151)		lua_pushstring(l,(key + HX_("PropertyData",3f,65,5a,e8)));
HXLINE( 152)		::llua::Convert_obj::toLua(l,value);
HXLINE( 153)		lua_settable(l,tableIndex);
HXLINE( 155)		lua_pop(l,2);
            	}
