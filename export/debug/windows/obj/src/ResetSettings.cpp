...
HXLINE(1831)		::haxe::Log_obj::trace(HX_("All settings have been reset",15,fe,86,77),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),1831,HX_("ResetSettings",b2,b9,cc,03),HX_("press",83,53,88,c8)));
