...
HX_DEFINE_STACK_FRAME(_hx_pos_e90bf299ab00f44e_733_new,"SongPositionOption","new",0xf73dda45,"SongPositionOption.new","Options.hx",733,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_742_left,"SongPositionOption","left",0x5d8ea682,"SongPositionOption.left","Options.hx",742,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_751_right,"SongPositionOption","right",0xf6501901,"SongPositionOption.right","Options.hx",751,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_e90bf299ab00f44e_758_getValue,"SongPositionOption","getValue",0x105e86f6,"SongPositionOption.getValue","Options.hx",758,0x9d9a0240)

void SongPositionOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_733_new)
HXLINE( 734)		super::__construct();
HXLINE( 735)		if (::OptionsMenu_obj::isInPause) {
HXLINE( 736)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE( 738)			this->description = desc;
            		}
            	}
...
bool SongPositionOption_obj::left(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_742_left)
HXLINE( 743)		if (::OptionsMenu_obj::isInPause) {
HXLINE( 744)			return false;
            		}
HXLINE( 745)		::flixel::FlxG_obj::save->data->__SetField(HX_("songPosition",9e,dd,3b,8d),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 746)		this->display = this->updateDisplay();
HXLINE( 747)		return true;
            	}


bool SongPositionOption_obj::right(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_751_right)
HXLINE( 752)		this->left();
HXLINE( 753)		return true;
            	}


::String SongPositionOption_obj::getValue(){
            	HX_STACKFRAME(&_hx_pos_e90bf299ab00f44e_758_getValue)
HXDLIN( 758)		::String _hx_tmp;
HXDLIN( 758)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("songPosition",9e,dd,3b,8d),::hx::paccDynamic)) ))) {
HXDLIN( 758)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 758)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 758)		return ((HX_("Song Position Bar: < ",f1,59,09,74) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
