...
HX_DEFINE_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_1688_new,"LockWeeksOption","new",0x229485fb,"LockWeeksOption.new","Options.hx",1688,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_1702_press,"LockWeeksOption","press",0x8495e5de,"LockWeeksOption.press","Options.hx",1702,0x9d9a0240)
static const bool _hx_array_data_f0cd6c89_2[] = {
	1,1,
};
HX_LOCAL_STACK_FRAME(_hx_pos_b4c29dfb4fdbfec8_1721_updateDisplay,"LockWeeksOption","updateDisplay",0x41787494,"LockWeeksOption.updateDisplay","Options.hx",1721,0x9d9a0240)

void LockWeeksOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_1688_new)
HXLINE(1690)		this->confirm = false;
HXLINE(1694)		super::__construct();
HXLINE(1695)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1696)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE(1698)			this->description = desc;
            		}
            	}
...
bool LockWeeksOption_obj::press(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_1702_press)
HXLINE(1703)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1704)			return false;
            		}
HXLINE(1705)		if (!(this->confirm)) {
HXLINE(1707)			this->confirm = true;
HXLINE(1708)			this->display = this->updateDisplay();
HXLINE(1709)			return true;
            		}
HXLINE(1711)		::flixel::FlxG_obj::save->data->__SetField(HX_("weekUnlocked",37,64,c4,a5),1,::hx::paccDynamic);
HXLINE(1712)		::StoryMenuState_obj::weekUnlocked = ::Array_obj< bool >::fromData( _hx_array_data_f0cd6c89_2,2);
HXLINE(1713)		this->confirm = false;
HXLINE(1714)		::haxe::Log_obj::trace(HX_("Weeks Locked",4b,55,ca,aa),::hx::SourceInfo(HX_("source/Options.hx",34,ca,fe,29),1714,HX_("LockWeeksOption",89,6c,cd,f0),HX_("press",83,53,88,c8)));
HXLINE(1715)		this->display = this->updateDisplay();
HXLINE(1716)		return true;
            	}


::String LockWeeksOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_b4c29dfb4fdbfec8_1721_updateDisplay)
HXDLIN(1721)		if (this->confirm) {
HXDLIN(1721)			return HX_("Confirm Story Reset",e4,1f,01,6b);
            		}
            		else {
HXDLIN(1721)			return HX_("Reset Story Progress",c9,28,76,d8);
            		}
HXDLIN(1721)		return null();
            	}
