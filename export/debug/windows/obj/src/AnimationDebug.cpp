...
HXLINE(  78)		this->background->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  79)		this->background->scale->set(((Float)0.7),((Float)0.7));
HXLINE(  80)		this->front->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
HXLINE(  81)		this->front->scale->set(((Float)0.7),((Float)0.7));
HXLINE(  82)		this->curt->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXLINE(  94)		this->dad->screenCenter(null());
...
HXLINE( 106)		{
HXLINE( 106)			 ::flixel::text::FlxText _this = this->textAnim;
HXDLIN( 106)			_this->set_borderStyle(::flixel::text::FlxTextBorderStyle_obj::OUTLINE_dyn());
HXDLIN( 106)			_this->set_borderColor(-16777216);
HXDLIN( 106)			_this->set_borderSize(( (Float)(2) ));
HXDLIN( 106)			_this->set_borderQuality(( (Float)(1) ));
            		}
...
HXLINE( 122)		 ::flixel::addons::ui::FlxUITabMenu _hx_tmp3 = this->UI_box;
HXDLIN( 122)		int _hx_tmp4 = ::flixel::FlxG_obj::width;
HXDLIN( 122)		_hx_tmp3->set_x(((( (Float)(_hx_tmp4) ) - this->UI_box->get_width()) - ( (Float)(20) )));
...
HXLINE( 155)			_gthis->dad->screenCenter(null());
...
HXLINE( 249)		::flixel::FlxG_obj::log->advanced(HX_("Successfully saved OFFSET DATA.",a9,84,8a,04),::flixel::_hx_system::debug::log::LogStyle_obj::NOTICE,null());
            	}
...
HXLINE( 272)		::flixel::FlxG_obj::log->advanced(HX_("Problem saving Offset data",92,86,55,e7),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
            	}
...
HXDLIN( 339)		if (_this->keyManager->checkStatus(27,_this->status)) {
...
HXDLIN( 345)		if (_this1->keyManager->checkStatus(69,_this1->status)) {
...
HXDLIN( 347)		if (_this2->keyManager->checkStatus(81,_this2->status)) {
...
HXDLIN( 350)		if (_this3->keyManager->checkStatus(70,_this3->status)) {
...
HXDLIN( 353)		if (!(_this4->keyManager->checkStatus(73,_this4->status))) {
HXLINE( 353)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 353)			_hx_tmp3 = _this->keyManager->checkStatus(74,_this->status);
            		}
            		else {
...
HXLINE( 353)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 353)			_hx_tmp2 = _this->keyManager->checkStatus(75,_this->status);
            		}
            		else {
...
HXLINE( 353)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->pressed) );
HXDLIN( 353)			_hx_tmp1 = _this->keyManager->checkStatus(76,_this->status);
            		}
            		else {
...
HXDLIN( 355)			if (_this->keyManager->checkStatus(73,_this->status)) {
...
HXDLIN( 357)				if (_this->keyManager->checkStatus(75,_this->status)) {
...
HXDLIN( 362)			if (_this1->keyManager->checkStatus(74,_this1->status)) {
...
HXDLIN( 364)				if (_this->keyManager->checkStatus(76,_this->status)) {
...
HXDLIN( 374)		if (_this5->keyManager->checkStatus(87,_this5->status)) {
...
HXDLIN( 379)		if (_this6->keyManager->checkStatus(83,_this6->status)) {
...
HXDLIN( 390)		if (!(_this7->keyManager->checkStatus(83,_this7->status))) {
HXLINE( 390)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 390)			_hx_tmp5 = _this->keyManager->checkStatus(87,_this->status);
            		}
            		else {
...
HXLINE( 390)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 390)			_hx_tmp4 = _this->keyManager->checkStatus(32,_this->status);
            		}
            		else {
...
HXDLIN( 403)		bool holdShift = _this8->keyManager->checkStatus(16,_this8->status);
...
HXDLIN( 425)		if (_this9->keyManager->checkStatus(17,_this9->status)) {
HXLINE( 425)			 ::flixel::input::keyboard::FlxKeyList _this = ( ( ::flixel::input::keyboard::FlxKeyList)(::flixel::FlxG_obj::keys->justPressed) );
HXDLIN( 425)			_hx_tmp9 = _this->keyManager->checkStatus(83,_this->status);
            		}
            		else {
...
HXDLIN( 428)		if (_this10->keyManager->checkStatus(112,_this10->status)) {
