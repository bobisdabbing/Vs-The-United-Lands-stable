...
HX_DECLARE_STACK_FRAME(_hx_pos_ad46d0c3569422f9_18_new)
...
HXLINE(  28)		( ( ::Section)(__this) )->mustHitSection = true;
HXLINE(  27)		( ( ::Section)(__this) )->typeOfSection = 0;
HXLINE(  26)		( ( ::Section)(__this) )->lengthInSteps = 16;
HXLINE(  24)		( ( ::Section)(__this) )->bpm = ((Float)0);
HXLINE(  23)		( ( ::Section)(__this) )->changeBPM = false;
HXLINE(  22)		( ( ::Section)(__this) )->sectionNotes = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  21)		( ( ::Section)(__this) )->endTime = ((Float)0);
HXLINE(  20)		( ( ::Section)(__this) )->startTime = ((Float)0);
HXLINE(  37)		( ( ::Section)(__this) )->lengthInSteps = lengthInSteps;
            	}
