...
class HXCPP_CLASS_ATTRIBUTES Paths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String file(::String file,::String library,::String type);
		...
		static bool doesTextAssetExist(::String path);
		static ::Dynamic doesTextAssetExist_dyn();
		...
		static  ::flixel::graphics::frames::FlxAtlasFrames getPackerAtlas(::String key,::String library, ::Dynamic isCharacter);
