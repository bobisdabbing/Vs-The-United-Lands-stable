...
HX_DEFINE_STACK_FRAME(_hx_pos_4303cb2e29fdc109_1026_new,"Judgement","new",0xcb22fc07,"Judgement.new","Options.hx",1026,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_4303cb2e29fdc109_1036_press,"Judgement","press",0x4636f6ea,"Judgement.press","Options.hx",1036,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_4303cb2e29fdc109_1046_updateDisplay,"Judgement","updateDisplay",0xf76371a0,"Judgement.updateDisplay","Options.hx",1046,0x9d9a0240)

void Judgement_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_4303cb2e29fdc109_1026_new)
HXLINE(1027)		super::__construct();
HXLINE(1028)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1029)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE(1031)			this->description = desc;
            		}
HXLINE(1032)		this->acceptValues = true;
            	}
...
bool Judgement_obj::press(){
            	HX_STACKFRAME(&_hx_pos_4303cb2e29fdc109_1036_press)
HXLINE(1037)		if (::OptionsMenu_obj::isInPause) {
HXLINE(1038)			return false;
            		}
HXLINE(1039)		::OptionsMenu_obj::instance->selectedCatIndex = 5;
HXLINE(1040)		::OptionsMenu_obj::instance->switchCat(::OptionsMenu_obj::instance->options->__get(5).StaticCast<  ::OptionCata >(),false);
HXLINE(1041)		return true;
            	}


::String Judgement_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_4303cb2e29fdc109_1046_updateDisplay)
HXDLIN(1046)		return HX_("Edit Judgements",74,44,87,2e);
            	}
