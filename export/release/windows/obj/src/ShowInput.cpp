...
HX_DEFINE_STACK_FRAME(_hx_pos_635a2d013c5acddb_999_new,"ShowInput","new",0x331b851f,"ShowInput.new","Options.hx",999,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_635a2d013c5acddb_1005_left,"ShowInput","left",0x83a67a68,"ShowInput.left","Options.hx",1005,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_635a2d013c5acddb_1012_right,"ShowInput","right",0x2511ae5b,"ShowInput.right","Options.hx",1012,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_635a2d013c5acddb_1019_updateDisplay,"ShowInput","updateDisplay",0x219b48b8,"ShowInput.updateDisplay","Options.hx",1019,0x9d9a0240)

void ShowInput_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_999_new)
HXLINE(1000)		super::__construct();
HXLINE(1001)		this->description = desc;
            	}
...
bool ShowInput_obj::left(){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_1005_left)
HXLINE(1006)		::flixel::FlxG_obj::save->data->__SetField(HX_("inputShow",27,92,7d,13),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("inputShow",27,92,7d,13),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(1007)		this->display = this->updateDisplay();
HXLINE(1008)		return true;
            	}


bool ShowInput_obj::right(){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_1012_right)
HXLINE(1013)		this->left();
HXLINE(1014)		return true;
            	}


::String ShowInput_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_635a2d013c5acddb_1019_updateDisplay)
HXDLIN(1019)		::String _hx_tmp;
HXDLIN(1019)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("inputShow",27,92,7d,13),::hx::paccDynamic)) )) {
HXDLIN(1019)			_hx_tmp = HX_("Enabled",61,2c,82,4b);
            		}
            		else {
HXDLIN(1019)			_hx_tmp = HX_("Disabled",9c,fd,b5,55);
            		}
HXDLIN(1019)		return ((HX_("Score Screen Debug: < ",57,eb,30,22) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
