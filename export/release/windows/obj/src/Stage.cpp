...
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_460_update,"Stage","update",0x01f9b1d9,"Stage.update","Stage.hx",460,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_484_stepHit,"Stage","stepHit",0x9bf3d897,"Stage.stepHit","Stage.hx",484,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_501_stepHit,"Stage","stepHit",0x9bf3d897,"Stage.stepHit","Stage.hx",501,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_522_beatHit,"Stage","beatHit",0x8eb714ad,"Stage.beatHit","Stage.hx",522,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_554_beatHit,"Stage","beatHit",0x8eb714ad,"Stage.beatHit","Stage.hx",554,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_571_beatHit,"Stage","beatHit",0x8eb714ad,"Stage.beatHit","Stage.hx",571,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_600_lightningStrikeShit,"Stage","lightningStrikeShit",0xc7dd82ec,"Stage.lightningStrikeShit","Stage.hx",600,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_629_trainStart,"Stage","trainStart",0xe162ef4a,"Stage.trainStart","Stage.hx",629,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_640_updateTrainPos,"Stage","updateTrainPos",0xaaf47da5,"Stage.updateTrainPos","Stage.hx",640,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_674_trainReset,"Stage","trainReset",0x441fc4b7,"Stage.trainReset","Stage.hx",674,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_695_resetFastCar,"Stage","resetFastCar",0x5e552099,"Stage.resetFastCar","Stage.hx",695,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_707_fastCarDrive,"Stage","fastCarDrive",0xcd297ee2,"Stage.fastCarDrive","Stage.hx",707,0xbcde5ee0)
HX_LOCAL_STACK_FRAME(_hx_pos_7b29f2b73a08853e_717_fastCarDrive,"Stage","fastCarDrive",0xcd297ee2,"Stage.fastCarDrive","Stage.hx",717,0xbcde5ee0)

void Stage_obj::__construct(::String daStage){
            	HX_GC_STACKFRAME(&_hx_pos_7b29f2b73a08853e_13_new)
HXLINE( 691)		this->fastCarCanDrive = true;
HXLINE( 636)		this->startedMoving = false;
HXLINE( 624)		this->trainCooldown = 0;
HXLINE( 623)		this->trainFinishing = false;
HXLINE( 622)		this->trainCars = 8;
HXLINE( 620)		this->trainFrameTiming = ((Float)0);
HXLINE( 619)		this->trainMoving = false;
HXLINE( 597)		this->curLight = 0;
HXLINE( 596)		this->lightningOffset = 8;
HXLINE( 595)		this->lightningStrikeBeat = 0;
...
HXLINE(  73)			goto _hx_goto_0;
            		...
            		if (  (_hx_switch_0==HX_("room",1b,ee,ae,4b)) ){
HXLINE( 416)			this->camZoom = ((Float)0.6);
HXLINE( 417)			this->curStage = HX_("room",1b,ee,ae,4b);
HXLINE( 419)			 ::flixel::FlxSprite rock =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-600,-200,null());
HXDLIN( 419)			 ::flixel::FlxSprite rock1 = rock->loadGraphic(::Paths_obj::loadImage(HX_("rock",a5,e3,ae,4b),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 420)			rock1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 421)			rock1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 422)			rock1->set_active(false);
HXLINE( 423)			this->swagBacks->set(HX_("rock",a5,e3,ae,4b),rock1);
HXLINE( 424)			this->toAdd->push(rock1);
...
HXLINE( 360)			goto _hx_goto_0;
            		...
            		/* default */{
HXLINE( 428)			this->camZoom = ((Float)0.9);
HXLINE( 429)			this->curStage = HX_("stage",be,6a,0b,84);
HXLINE( 430)			 ::flixel::FlxSprite bg =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-600,-200,null());
HXDLIN( 430)			 ::flixel::FlxSprite bg1 = bg->loadGraphic(::Paths_obj::loadImage(HX_("stageback",e5,7b,3b,06),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 431)			bg1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 432)			bg1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 433)			bg1->set_active(false);
HXLINE( 434)			this->swagBacks->set(HX_("bg",c5,55,00,00),bg1);
HXLINE( 435)			this->toAdd->push(bg1);
HXLINE( 437)			 ::flixel::FlxSprite stageFront =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-650,600,null());
HXDLIN( 437)			 ::flixel::FlxSprite stageFront1 = stageFront->loadGraphic(::Paths_obj::loadImage(HX_("stagefront",2b,fd,b0,c6),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 438)			stageFront1->setGraphicSize(::Std_obj::_hx_int((stageFront1->get_width() * ((Float)1.1))),null());
HXLINE( 439)			stageFront1->updateHitbox();
HXLINE( 440)			stageFront1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 441)			stageFront1->scrollFactor->set(((Float)0.9),((Float)0.9));
HXLINE( 442)			stageFront1->set_active(false);
HXLINE( 443)			this->swagBacks->set(HX_("stageFront",0b,6d,de,59),stageFront1);
HXLINE( 444)			this->toAdd->push(stageFront1);
HXLINE( 446)			 ::flixel::FlxSprite stageCurtains =  ::flixel::FlxSprite_obj::__alloc( HX_CTX ,-500,-300,null());
HXDLIN( 446)			 ::flixel::FlxSprite stageCurtains1 = stageCurtains->loadGraphic(::Paths_obj::loadImage(HX_("stagecurtains",df,ec,1a,4b),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 447)			stageCurtains1->setGraphicSize(::Std_obj::_hx_int((stageCurtains1->get_width() * ((Float)0.9))),null());
HXLINE( 448)			stageCurtains1->updateHitbox();
HXLINE( 449)			stageCurtains1->set_antialiasing(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("antialiasing",f4,16,b3,48),::hx::paccDynamic)) ));
HXLINE( 450)			stageCurtains1->scrollFactor->set(((Float)1.3),((Float)1.3));
HXLINE( 451)			stageCurtains1->set_active(false);
HXLINE( 453)			this->swagBacks->set(HX_("stageCurtains",ff,a8,cc,24),stageCurtains1);
HXLINE( 454)			this->toAdd->push(stageCurtains1);
            		}
            		_hx_goto_0:;
            	}
...
void Stage_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_460_update)
HXLINE( 461)		this->super::update(elapsed);
HXLINE( 463)		if (!(::PlayStateChangeables_obj::Optimize)) {
HXLINE( 465)			if ((this->curStage == HX_("philly",28,77,5e,ef))) {
HXLINE( 468)				if (this->trainMoving) {
HXLINE( 470)					 ::Stage _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 470)					_hx_tmp->trainFrameTiming = (_hx_tmp->trainFrameTiming + elapsed);
HXLINE( 472)					if ((this->trainFrameTiming >= ((Float)0.041666666666666664))) {
HXLINE( 474)						this->updateTrainPos();
HXLINE( 475)						this->trainFrameTiming = ( (Float)(0) );
            					}
            				}
            			}
            		}
...
void Stage_obj::stepHit(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_484_stepHit)
HXLINE( 485)		this->super::stepHit();
HXLINE( 487)		if (!(::PlayStateChangeables_obj::Optimize)) {
HXLINE( 489)			::Array< ::Dynamic> array = ( (::Array< ::Dynamic>)(this->slowBacks->get(this->curStep)) );
HXLINE( 490)			bool _hx_tmp;
HXDLIN( 490)			if (::hx::IsNotNull( array )) {
HXLINE( 490)				_hx_tmp = (array->length > 0);
            			}
            			else {
HXLINE( 490)				_hx_tmp = false;
            			}
HXDLIN( 490)			if (_hx_tmp) {
HXLINE( 492)				if (this->hideLastBG) {
HXLINE( 494)					{
HXLINE( 494)						 ::Dynamic bg = this->swagBacks->iterator();
HXDLIN( 494)						while(( (bool)(bg->__Field(HX_("hasNext",6d,a5,46,18),::hx::paccDynamic)()) )){
HXLINE( 494)							 ::flixel::FlxSprite bg1 = ( ( ::flixel::FlxSprite)(bg->__Field(HX_("next",f3,84,02,49),::hx::paccDynamic)()) );
HXLINE( 496)							if (!(array->contains(bg1))) {
            								HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::flixel::FlxSprite,bg1) HXARGC(1)
            								void _hx_run( ::flixel::tweens::FlxTween tween){
            									HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_501_stepHit)
HXLINE( 501)									bg1->set_visible(false);
            								}
            								HX_END_LOCAL_FUNC1((void))

HXLINE( 498)								 ::flixel::tweens::misc::VarTween tween = ::flixel::tweens::FlxTween_obj::tween(bg1, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 506)					{
HXLINE( 506)						int _g = 0;
HXDLIN( 506)						while((_g < array->length)){
HXLINE( 506)							 ::flixel::FlxSprite bg = array->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 506)							_g = (_g + 1);
HXLINE( 508)							bg->set_visible(true);
HXLINE( 509)							::flixel::tweens::FlxTween_obj::tween(bg, ::Dynamic(::hx::Anon_obj::Create(1)
...
HXLINE( 514)					int _g = 0;
HXDLIN( 514)					while((_g < array->length)){
HXLINE( 514)						 ::flixel::FlxSprite bg = array->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 514)						_g = (_g + 1);
HXLINE( 515)						bg->set_visible(!(bg->visible));
            					}
            				}
            			}
            		}
...
void Stage_obj::beatHit(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_522_beatHit)
HXLINE( 523)		this->super::beatHit();
HXLINE( 525)		bool _hx_tmp;
HXDLIN( 525)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 525)			_hx_tmp = (this->animatedBacks->length > 0);
            		}
            		else {
...
HXLINE( 527)			int _g = 0;
HXDLIN( 527)			::Array< ::Dynamic> _g1 = this->animatedBacks;
HXDLIN( 527)			while((_g < _g1->length)){
HXLINE( 527)				 ::flixel::FlxSprite bg = _g1->__get(_g).StaticCast<  ::flixel::FlxSprite >();
HXDLIN( 527)				_g = (_g + 1);
HXLINE( 528)				bg->animation->play(HX_("idle",14,a7,b3,45),true,null(),null());
            			}
            		}
HXLINE( 531)		if (!(::PlayStateChangeables_obj::Optimize)) {
HXLINE( 533)			::String _hx_switch_0 = this->curStage;
            			if (  (_hx_switch_0==HX_("halloween",8d,bb,38,50)) ){
HXLINE( 536)				bool _hx_tmp;
HXDLIN( 536)				Float Chance;
HXDLIN( 536)				if ((::Conductor_obj::bpm > 320)) {
HXLINE( 536)					Chance = ( (Float)(100) );
            				}
            				else {
HXLINE( 536)					Chance = ( (Float)(10) );
            				}
HXDLIN( 536)				if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < Chance)) {
HXLINE( 536)					_hx_tmp = (this->curBeat > (this->lightningStrikeBeat + this->lightningOffset));
            				}
            				else {
...
HXLINE( 540)						this->lightningStrikeShit();
            					}
            				}
HXLINE( 536)				goto _hx_goto_25;
            			}
            			if (  (_hx_switch_0==HX_("limo",1f,17,b3,47)) ){
HXLINE( 550)				if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
            					HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_0) HXARGC(1)
            					void _hx_run( ::BackgroundDancer dancer){
            						HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_554_beatHit)
HXLINE( 554)						dancer->dance();
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 552)					( ( ::flixel::group::FlxTypedGroup)(this->swagGroup->get(HX_("grpLimoDancers",70,18,93,51))) )->forEach( ::Dynamic(new _hx_Closure_0()),null());
HXLINE( 557)					bool _hx_tmp;
HXDLIN( 557)					if ((::flixel::FlxG_obj::random->_hx_float(0,100,null()) < 10)) {
HXLINE( 557)						_hx_tmp = this->fastCarCanDrive;
            					}
            					else {
HXLINE( 557)						_hx_tmp = false;
            					}
HXDLIN( 557)					if (_hx_tmp) {
HXLINE( 558)						this->fastCarDrive();
            					}
            				}
HXLINE( 550)				goto _hx_goto_25;
            			}
            			if (  (_hx_switch_0==HX_("philly",28,77,5e,ef)) ){
HXLINE( 561)				if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 563)					if (!(this->trainMoving)) {
HXLINE( 564)						 ::Stage _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 564)						_hx_tmp->trainCooldown = (_hx_tmp->trainCooldown + 1);
            					}
HXLINE( 566)					if ((::hx::Mod(this->curBeat,4) == 0)) {
            						HX_BEGIN_LOCAL_FUNC_S0(::hx::LocalFunc,_hx_Closure_1) HXARGC(1)
            						void _hx_run( ::flixel::FlxSprite light){
            							HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_571_beatHit)
HXLINE( 571)							light->set_visible(false);
            						}
            						HX_END_LOCAL_FUNC1((void))

HXLINE( 568)						 ::flixel::group::FlxTypedGroup phillyCityLights = ( ( ::flixel::group::FlxTypedGroup)(this->swagGroup->get(HX_("phillyCityLights",30,e0,12,1f))) );
HXLINE( 569)						phillyCityLights->forEach( ::Dynamic(new _hx_Closure_1()),null());
HXLINE( 574)						this->curLight = ::flixel::FlxG_obj::random->_hx_int(0,(phillyCityLights->length - 1),null());
HXLINE( 576)						phillyCityLights->members->__get(this->curLight)->__SetField(HX_("visible",72,78,24,a3),true,::hx::paccDynamic);
            					}
            				}
HXLINE( 581)				bool _hx_tmp;
HXDLIN( 581)				bool _hx_tmp1;
HXDLIN( 581)				bool _hx_tmp2;
HXDLIN( 581)				if ((::hx::Mod(this->curBeat,8) == 4)) {
HXLINE( 581)					Float Chance;
HXDLIN( 581)					if ((::Conductor_obj::bpm > 320)) {
HXLINE( 581)						Chance = ( (Float)(150) );
            					}
            					else {
HXLINE( 581)						Chance = ( (Float)(30) );
            					}
HXDLIN( 581)					_hx_tmp2 = (::flixel::FlxG_obj::random->_hx_float(0,100,null()) < Chance);
            				}
            				else {
HXLINE( 581)					_hx_tmp2 = false;
            				}
HXDLIN( 581)				if (_hx_tmp2) {
HXLINE( 581)					_hx_tmp1 = !(this->trainMoving);
            				}
            				else {
HXLINE( 581)					_hx_tmp1 = false;
            				}
HXDLIN( 581)				if (_hx_tmp1) {
HXLINE( 581)					_hx_tmp = (this->trainCooldown > 8);
            				}
            				else {
HXLINE( 581)					_hx_tmp = false;
            				}
HXDLIN( 581)				if (_hx_tmp) {
HXLINE( 583)					if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 585)						this->trainCooldown = ::flixel::FlxG_obj::random->_hx_int(-4,0,null());
HXLINE( 586)						this->trainStart();
            					}
            				}
HXLINE( 560)				goto _hx_goto_25;
            			}
            			if (  (_hx_switch_0==HX_("school",74,b8,c8,40)) ){
HXLINE( 545)				if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 547)					this->swagBacks->get(HX_("bgGirls",92,16,2b,41))->__Field(HX_("dance",33,83,83,d4),::hx::paccDynamic)();
            				}
...
void Stage_obj::lightningStrikeShit(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_600_lightningStrikeShit)
HXLINE( 601)		 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 601)		_hx_tmp->play(::Paths_obj::sound((HX_("thunder_",bb,58,cf,2f) + ::flixel::FlxG_obj::random->_hx_int(1,2,null())),HX_("shared",a5,5e,2b,1d)),null(),null(),null(),null(),null());
HXLINE( 602)		 ::Dynamic(this->swagBacks->get(HX_("halloweenBG",92,b2,88,5c))->__Field(HX_("animation",04,ef,34,4b),::hx::paccDynamic))->__Field(HX_("play",f4,2d,5a,4a),::hx::paccDynamic)(HX_("lightning",0a,39,4a,d7));
HXLINE( 604)		this->lightningStrikeBeat = this->curBeat;
HXLINE( 605)		this->lightningOffset = ::flixel::FlxG_obj::random->_hx_int(8,24,null());
HXLINE( 607)		if (::hx::IsNotNull( ::PlayState_obj::boyfriend )) {
HXLINE( 609)			::PlayState_obj::boyfriend->playAnim(HX_("scared",20,78,2a,3c),true,null(),null());
HXLINE( 610)			::PlayState_obj::gf->playAnim(HX_("scared",20,78,2a,3c),true,null(),null());
            		}
            		else {
HXLINE( 614)			::GameplayCustomizeState_obj::boyfriend->playAnim(HX_("scared",20,78,2a,3c),true,null(),null());
HXLINE( 615)			::GameplayCustomizeState_obj::gf->playAnim(HX_("scared",20,78,2a,3c),true,null(),null());
            		}
            	}
...
void Stage_obj::trainStart(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_629_trainStart)
HXDLIN( 629)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 631)			this->trainMoving = true;
HXLINE( 632)			this->trainSound->play(true,null(),null());
            		}
            	}
...
void Stage_obj::updateTrainPos(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_640_updateTrainPos)
HXDLIN( 640)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 642)			if ((this->trainSound->_time >= 4700)) {
HXLINE( 644)				this->startedMoving = true;
HXLINE( 646)				if (::hx::IsNotNull( ::PlayState_obj::gf )) {
HXLINE( 647)					::PlayState_obj::gf->playAnim(HX_("hairBlow",b4,c9,39,c9),null(),null(),null());
            				}
            				else {
HXLINE( 649)					::GameplayCustomizeState_obj::gf->playAnim(HX_("hairBlow",b4,c9,39,c9),null(),null(),null());
            				}
            			}
HXLINE( 652)			if (this->startedMoving) {
HXLINE( 654)				 ::Dynamic phillyTrain = this->swagBacks->get(HX_("phillyTrain",80,9b,65,bb));
HXLINE( 655)				 ::Dynamic phillyTrain1 = phillyTrain;
HXDLIN( 655)				phillyTrain1->__SetField(HX_("x",78,00,00,00),( ::Dynamic(phillyTrain1->__Field(HX_("x",78,00,00,00),::hx::paccDynamic)) - 400),::hx::paccDynamic);
HXLINE( 657)				bool _hx_tmp;
HXDLIN( 657)				if (::hx::IsLess( phillyTrain->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),-2000 )) {
HXLINE( 657)					_hx_tmp = !(this->trainFinishing);
            				}
            				else {
HXLINE( 657)					_hx_tmp = false;
            				}
HXDLIN( 657)				if (_hx_tmp) {
HXLINE( 659)					phillyTrain->__SetField(HX_("x",78,00,00,00),-1150,::hx::paccDynamic);
HXLINE( 660)					 ::Stage _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 660)					_hx_tmp->trainCars = (_hx_tmp->trainCars - 1);
HXLINE( 662)					if ((this->trainCars <= 0)) {
HXLINE( 663)						this->trainFinishing = true;
            					}
            				}
HXLINE( 666)				bool _hx_tmp1;
HXDLIN( 666)				if (::hx::IsLess( phillyTrain->__Field(HX_("x",78,00,00,00),::hx::paccDynamic),-4000 )) {
HXLINE( 666)					_hx_tmp1 = this->trainFinishing;
            				}
            				else {
HXLINE( 666)					_hx_tmp1 = false;
            				}
HXDLIN( 666)				if (_hx_tmp1) {
HXLINE( 667)					this->trainReset();
            				}
            			}
            		}
            	}
...
void Stage_obj::trainReset(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_674_trainReset)
HXDLIN( 674)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 676)			if (::hx::IsNotNull( ::PlayState_obj::gf )) {
HXLINE( 677)				::PlayState_obj::gf->playAnim(HX_("hairFall",bd,48,d6,cb),null(),null(),null());
            			}
            			else {
HXLINE( 679)				::GameplayCustomizeState_obj::gf->playAnim(HX_("hairFall",bd,48,d6,cb),null(),null(),null());
            			}
HXLINE( 681)			this->swagBacks->get(HX_("phillyTrain",80,9b,65,bb))->__SetField(HX_("x",78,00,00,00),(::flixel::FlxG_obj::width + 200),::hx::paccDynamic);
HXLINE( 682)			this->trainMoving = false;
HXLINE( 685)			this->trainCars = 8;
HXLINE( 686)			this->trainFinishing = false;
HXLINE( 687)			this->startedMoving = false;
            		}
            	}
...
void Stage_obj::resetFastCar(){
            	HX_STACKFRAME(&_hx_pos_7b29f2b73a08853e_695_resetFastCar)
HXDLIN( 695)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
HXLINE( 697)			 ::Dynamic fastCar = this->swagBacks->get(HX_("fastCar",d8,f2,1f,de));
HXLINE( 698)			fastCar->__SetField(HX_("x",78,00,00,00),-12600,::hx::paccDynamic);
HXLINE( 699)			fastCar->__SetField(HX_("y",79,00,00,00),::flixel::FlxG_obj::random->_hx_int(140,250,null()),::hx::paccDynamic);
HXLINE( 700)			 ::Dynamic(fastCar->__Field(HX_("velocity",1d,02,fe,1e),::hx::paccDynamic))->__SetField(HX_("x",78,00,00,00),0,::hx::paccDynamic);
HXLINE( 701)			fastCar->__SetField(HX_("visible",72,78,24,a3),false,::hx::paccDynamic);
HXLINE( 702)			this->fastCarCanDrive = true;
            		}
            	}
...
void Stage_obj::fastCarDrive(){
            	HX_GC_STACKFRAME(&_hx_pos_7b29f2b73a08853e_707_fastCarDrive)
HXLINE( 706)		 ::Stage _gthis = ::hx::ObjectPtr<OBJ_>(this);
HXLINE( 708)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("distractions",31,13,7d,60),::hx::paccDynamic)) )) {
            			HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Stage,_gthis) HXARGC(1)
            			void _hx_run( ::flixel::util::FlxTimer tmr){
            				HX_GC_STACKFRAME(&_hx_pos_7b29f2b73a08853e_717_fastCarDrive)
HXLINE( 717)				_gthis->resetFastCar();
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 710)			 ::flixel::_hx_system::frontEnds::SoundFrontEnd _hx_tmp = ::flixel::FlxG_obj::sound;
HXDLIN( 710)			_hx_tmp->play(::Paths_obj::sound((HX_("carPass",05,1f,44,b6) + ::flixel::FlxG_obj::random->_hx_int(0,1,null())),HX_("shared",a5,5e,2b,1d)),((Float)0.7),null(),null(),null(),null());
HXLINE( 712)			this->swagBacks->get(HX_("fastCar",d8,f2,1f,de))->__SetField(HX_("visible",72,78,24,a3),true,::hx::paccDynamic);
HXLINE( 713)			 ::Dynamic _hx_tmp1 = this->swagBacks->get(HX_("fastCar",d8,f2,1f,de));
HXDLIN( 713)			int _hx_tmp2 = ::flixel::FlxG_obj::random->_hx_int(170,220,null());
HXDLIN( 713)			 ::Dynamic(_hx_tmp1->__Field(HX_("velocity",1d,02,fe,1e),::hx::paccDynamic))->__SetField(HX_("x",78,00,00,00),((( (Float)(_hx_tmp2) ) / ::flixel::FlxG_obj::elapsed) * ( (Float)(3) )),::hx::paccDynamic);
HXLINE( 714)			this->fastCarCanDrive = false;
HXLINE( 715)			 ::flixel::util::FlxTimer_obj::__alloc( HX_CTX ,null())->start(2, ::Dynamic(new _hx_Closure_0(_gthis)),null());
            		}
            	}
