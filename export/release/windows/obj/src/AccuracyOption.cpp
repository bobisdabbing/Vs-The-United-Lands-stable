...
HX_DEFINE_STACK_FRAME(_hx_pos_073f38f294c4fadc_701_new,"AccuracyOption","new",0x53bf62a0,"AccuracyOption.new","Options.hx",701,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_710_left,"AccuracyOption","left",0xf2646dc7,"AccuracyOption.left","Options.hx",710,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_719_right,"AccuracyOption","right",0x9c88ae1c,"AccuracyOption.right","Options.hx",719,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_073f38f294c4fadc_726_updateDisplay,"AccuracyOption","updateDisplay",0x7ea97179,"AccuracyOption.updateDisplay","Options.hx",726,0x9d9a0240)

void AccuracyOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_701_new)
HXLINE( 702)		super::__construct();
HXLINE( 703)		if (::OptionsMenu_obj::isInPause) {
HXLINE( 704)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE( 706)			this->description = desc;
            		}
            	}
...
bool AccuracyOption_obj::left(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_710_left)
HXLINE( 711)		if (::OptionsMenu_obj::isInPause) {
HXLINE( 712)			return false;
            		}
HXLINE( 713)		::flixel::FlxG_obj::save->data->__SetField(HX_("accuracyDisplay",09,75,5e,26),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 714)		this->display = this->updateDisplay();
HXLINE( 715)		return true;
            	}


bool AccuracyOption_obj::right(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_719_right)
HXLINE( 720)		this->left();
HXLINE( 721)		return true;
            	}


::String AccuracyOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_073f38f294c4fadc_726_updateDisplay)
HXDLIN( 726)		::String _hx_tmp;
HXDLIN( 726)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("accuracyDisplay",09,75,5e,26),::hx::paccDynamic)) ))) {
HXDLIN( 726)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN( 726)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN( 726)		return ((HX_("Accuracy Display < ",09,ae,0c,2b) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
