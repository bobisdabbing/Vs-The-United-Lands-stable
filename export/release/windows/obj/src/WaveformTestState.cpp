...
HXDLIN(  44)		if (_this->keyManager->checkStatus(87,_this->status)) {
...
HXDLIN(  46)		if (_this1->keyManager->checkStatus(83,_this1->status)) {
...
HXDLIN(  48)		if (_this2->keyManager->checkStatus(65,_this2->status)) {
...
HXDLIN(  50)		if (_this3->keyManager->checkStatus(68,_this3->status)) {
