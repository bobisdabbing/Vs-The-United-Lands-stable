...
HX_DEFINE_STACK_FRAME(_hx_pos_0438001de6863180_797_new,"Colour","new",0x7d6b835e,"Colour.new","Options.hx",797,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0438001de6863180_806_left,"Colour","left",0x3f54f349,"Colour.left","Options.hx",806,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0438001de6863180_815_right,"Colour","right",0xa20cfa5a,"Colour.right","Options.hx",815,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_0438001de6863180_822_updateDisplay,"Colour","updateDisplay",0x69d12bb7,"Colour.updateDisplay","Options.hx",822,0x9d9a0240)

void Colour_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_797_new)
HXLINE( 798)		super::__construct();
HXLINE( 799)		if (::OptionsMenu_obj::isInPause) {
HXLINE( 800)			this->description = HX_("This option cannot be toggled in the pause menu.",b4,21,dd,c9);
            		}
            		else {
HXLINE( 802)			this->description = desc;
            		}
            	}
...
bool Colour_obj::left(){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_806_left)
HXLINE( 807)		if (::OptionsMenu_obj::isInPause) {
HXLINE( 808)			return false;
            		}
HXLINE( 809)		::flixel::FlxG_obj::save->data->__SetField(HX_("colour",4c,c8,86,c6),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("colour",4c,c8,86,c6),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE( 810)		this->display = this->updateDisplay();
HXLINE( 811)		return true;
            	}


bool Colour_obj::right(){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_815_right)
HXLINE( 816)		this->left();
HXLINE( 817)		return true;
            	}


::String Colour_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_0438001de6863180_822_updateDisplay)
HXDLIN( 822)		::String _hx_tmp;
HXDLIN( 822)		if (( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("colour",4c,c8,86,c6),::hx::paccDynamic)) )) {
HXDLIN( 822)			_hx_tmp = HX_("Enabled",61,2c,82,4b);
            		}
            		else {
HXDLIN( 822)			_hx_tmp = HX_("Disabled",9c,fd,b5,55);
            		}
HXDLIN( 822)		return ((HX_("Colored HP Bars: < ",44,ef,e3,ac) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
