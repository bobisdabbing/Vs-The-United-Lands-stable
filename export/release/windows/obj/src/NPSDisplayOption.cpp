...
HX_DEFINE_STACK_FRAME(_hx_pos_94908c72a49529df_1230_new,"NPSDisplayOption","new",0x0195d6b8,"NPSDisplayOption.new","Options.hx",1230,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_1236_left,"NPSDisplayOption","left",0x60338eaf,"NPSDisplayOption.left","Options.hx",1236,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_1243_right,"NPSDisplayOption","right",0x43f65834,"NPSDisplayOption.right","Options.hx",1243,0x9d9a0240)
HX_LOCAL_STACK_FRAME(_hx_pos_94908c72a49529df_1250_updateDisplay,"NPSDisplayOption","updateDisplay",0xf172f391,"NPSDisplayOption.updateDisplay","Options.hx",1250,0x9d9a0240)

void NPSDisplayOption_obj::__construct(::String desc){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_1230_new)
HXLINE(1231)		super::__construct();
HXLINE(1232)		this->description = desc;
            	}
...
bool NPSDisplayOption_obj::left(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_1236_left)
HXLINE(1237)		::flixel::FlxG_obj::save->data->__SetField(HX_("npsDisplay",51,08,e2,23),!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) )),::hx::paccDynamic);
HXLINE(1238)		this->display = this->updateDisplay();
HXLINE(1239)		return true;
            	}


bool NPSDisplayOption_obj::right(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_1243_right)
HXLINE(1244)		this->left();
HXLINE(1245)		return true;
            	}


::String NPSDisplayOption_obj::updateDisplay(){
            	HX_STACKFRAME(&_hx_pos_94908c72a49529df_1250_updateDisplay)
HXDLIN(1250)		::String _hx_tmp;
HXDLIN(1250)		if (!(( (bool)(::flixel::FlxG_obj::save->data->__Field(HX_("npsDisplay",51,08,e2,23),::hx::paccDynamic)) ))) {
HXDLIN(1250)			_hx_tmp = HX_("off",6f,93,54,00);
            		}
            		else {
HXDLIN(1250)			_hx_tmp = HX_("on",1f,61,00,00);
            		}
HXDLIN(1250)		return ((HX_("NPS Display: < ",dd,06,e6,17) + _hx_tmp) + HX_(" >",1e,1c,00,00));
            	}
