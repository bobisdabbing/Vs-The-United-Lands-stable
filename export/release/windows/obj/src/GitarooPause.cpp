...
HXLINE(  34)		bf->screenCenter(::flixel::util::FlxAxes_obj::X_dyn());
...
HXLINE(  37)		 ::flixel::FlxSprite _hx_tmp = this->replayButton;
HXDLIN(  37)		_hx_tmp->set_frames(::Paths_obj::getSparrowAtlas(HX_("pauseAlt/pauseUI",4e,e1,5d,69),null(),null()));
...
HXLINE(  45)		 ::flixel::FlxSprite _hx_tmp1 = this->cancelButton;
HXDLIN(  45)		_hx_tmp1->set_frames(::Paths_obj::getSparrowAtlas(HX_("pauseAlt/pauseUI",4e,e1,5d,69),null(),null()));
