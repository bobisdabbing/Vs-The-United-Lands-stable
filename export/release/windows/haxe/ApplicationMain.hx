...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Vs The United Lands", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Vs The United Lands", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Vs The United Lands";
		app.meta["name"] = "Friday Night Funkin': Vs The United Lands";
		...
		var attributes:lime.ui.WindowAttributes = {
			...
			parameters: {},
			resizable: true,
			title: "Friday Night Funkin': Vs The United Lands",
			width: 1280,
			x: null,
			y: null,
		};
